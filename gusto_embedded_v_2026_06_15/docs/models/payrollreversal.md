...
| `reversal_payroll_uuid`                                  | *OptionalNullable[str]*                                  | :heavy_minus_sign:                                       | The UUID of the payroll where the reversal was applied.  |
...
| `category`                                               | *OptionalNullable[str]*                                  | :heavy_minus_sign:                                       | Category chosen by the admin who requested the reversal. |
