...
```python
from gusto_embedded_v_2026_06_15.models import PutV1TimeOffPoliciesTimeOffPolicyUUIDAccrualMethod

value = PutV1TimeOffPoliciesTimeOffPolicyUUIDAccrualMethod.UNLIMITED
```
