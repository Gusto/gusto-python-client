...
<!-- UsageSnippet language="python" operationID="post-v1-bulk_reports" method="post" path="/v1/bulk_reports" -->
```python
...
with Gusto() as gusto:
    ...
    res = gusto.reports.post_v1_bulk_reports(security=gusto_embedded_v_2026_06_15.PostV1BulkReportsSecurity(
    ...
    ), batch=[
        {
            ...
            "columns": [
                gusto_embedded_v_2026_06_15.Columns.EMPLOYEE_FIRST_NAME,
            ],
            "groupings": [
                gusto_embedded_v_2026_06_15.Groupings.EMPLOYEE,
            ],
            "file_type": gusto_embedded_v_2026_06_15.FileType.CSV,
            "custom_name": "Q1 Payroll Export",
            "with_totals": False,
            "date_filter_type": gusto_embedded_v_2026_06_15.DateFilterType.CHECK_DATE,
            "start_date": date.fromisoformat("2026-01-01"),
            "end_date": date.fromisoformat("2026-03-31"),
            "payment_method": gusto_embedded_v_2026_06_15.PaymentMethod.CHECK,
            "employment_type": gusto_embedded_v_2026_06_15.EmploymentType.EXEMPT,
            "employment_status": gusto_embedded_v_2026_06_15.EmploymentStatus.ACTIVE_FULL_TIME,
        },
        {
            "company_uuid": "12345678-abcd-ef12-3456-7890abcdef12",
            "report_type": "general_ledger",
            "payroll_uuid": "7b1d0df1-6403-4a06-8768-c1dd7d24d27a",
            "aggregation": gusto_embedded_v_2026_06_15.Aggregation.DEFAULT,
        },
    ], x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1BulkReportsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                                                                                                                                   | [models.PostV1BulkReportsSecurity](../../models/postv1bulkreportssecurity.md)                                                                                                                                                | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
| `x_gusto_api_version`                                                                                                                                                                                                        | [Optional[models.PostV1BulkReportsHeaderXGustoAPIVersion]](../../models/postv1bulkreportsheaderxgustoapiversion.md)                                                                                                          | :heavy_minus_sign:                                                                                                                                                                                                           | Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. |
| `retries`                                                                                                                                                                                                                    | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                                                                                                                             | :heavy_minus_sign:                                                                                                                                                                                                           | Configuration to override the default retry behavior of the client.                                                                                                                                                          |

### Response

**[models.CreateBulkReport](../../models/createbulkreport.md)**
...
<!-- UsageSnippet language="python" operationID="get-v1-bulk_reports-request_uuid" method="get" path="/v1/bulk_reports/{request_uuid}" -->
```python
import gusto_embedded_v_2026_06_15
from gusto_embedded_v_2026_06_15 import Gusto
import os
...
with Gusto() as gusto:
    ...
    res = gusto.reports.get_v1_bulk_reports_request_uuid(security=gusto_embedded_v_2026_06_15.GetV1BulkReportsRequestUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), request_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1BulkReportsRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
| Parameter                                                                                                                                                                                                                    | Type                                                                                                                                                                                                                         | Required                                                                                                                                                                                                                     | Description                                                                                                                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                                                                                                                                   | [models.GetV1BulkReportsRequestUUIDSecurity](../../models/getv1bulkreportsrequestuuidsecurity.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                          |
...
**[models.BulkReport](../../models/bulkreport.md)**
...
with Gusto(
    ...
    res = gusto.reports.post_v1_companies_company_id_reports_employees_annual_fica_wage(company_id="<id>", start_year=2023, end_year=2024, x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1CompaniesCompanyIDReportsEmployeesAnnualFicaWageHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
**[models.EmployeesAnnualFicaWageReportAcceptance](../../models/employeesannualficawagereportacceptance.md)**
...
with Gusto(
    ...
    res = gusto.reports.create_custom(company_uuid="<id>", columns=[
        gusto_embedded_v_2026_06_15.CreateReportBodyColumns.TOTAL_TIME_OFF_EARNINGS,
    ], file_type=gusto_embedded_v_2026_06_15.CreateReportBodyFileType.JSON, x_gusto_api_version=gusto_embedded_v_2026_06_15.PostCompaniesCompanyUUIDReportsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, with_totals=False, date_filter_type=gusto_embedded_v_2026_06_15.CreateReportBodyDateFilterType.PERIOD_END_DATE, start_date=date.fromisoformat("2024-01-01"), end_date=date.fromisoformat("2024-04-01"), dismissed_start_date=date.fromisoformat("2024-01-01"), dismissed_end_date=date.fromisoformat("2024-04-01"))
...
with Gusto(
    ...
    res = gusto.reports.post_payrolls_payroll_uuid_reports_general_ledger(payroll_uuid="<id>", aggregation=gusto_embedded_v_2026_06_15.GeneralLedgerReportBodyAggregation.DEFAULT, x_gusto_api_version=gusto_embedded_v_2026_06_15.PostPayrollsPayrollUUIDReportsGeneralLedgerHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
| `aggregation`                                                                                                                                                                                                                | [models.GeneralLedgerReportBodyAggregation](../../models/generalledgerreportbodyaggregation.md)                                                                                                                              | :heavy_check_mark:                                                                                                                                                                                                           | The breakdown of the report. Use 'default' for no split.                                                                                                                                                                     |
...
with Gusto(
    ...
    res = gusto.reports.get_reports_request_uuid(request_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetReportsRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.reports.get_template(company_uuid="<id>", report_type="<value>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetCompaniesCompanyUUIDReportTemplatesReportTypeHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
