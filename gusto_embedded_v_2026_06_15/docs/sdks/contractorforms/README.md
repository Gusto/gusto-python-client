...
with Gusto(
    ...
    res = gusto.contractor_forms.list(contractor_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorFormsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_forms.get(contractor_uuid="<id>", form_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_forms.get_pdf(contractor_uuid="<id>", form_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_forms.generate1099(contractor_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1SandboxGenerate1099HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
