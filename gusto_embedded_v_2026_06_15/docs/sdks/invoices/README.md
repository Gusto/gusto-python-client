...
with Gusto() as gusto:
    ...
    res = gusto.invoices.get(security=gusto_embedded_v_2026_06_15.GetInvoicesInvoicePeriodSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), invoice_period="<value>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetInvoicesInvoicePeriodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
