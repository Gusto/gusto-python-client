...
with Gusto(
    ...
    res = gusto.contractor_payments.get_v1_contractors_contractor_uuid_payments(contractor_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorsContractorUUIDPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, sort_by="check_date:desc")
...
with Gusto(
    ...
    gusto.contractor_payments.get_v1_contractor_payments_contractor_payment_id_pdf(contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorPaymentsContractorPaymentIDPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.list(company_id="<id>", start_date="2020-01-01", end_date="2020-12-31", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.create(company_id="<id>", contractor_uuid="<id>", date_=date.fromisoformat("2020-01-01"), x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, payment_method=gusto_embedded_v_2026_06_15.ContractorPaymentBodyPaymentMethod.DIRECT_DEPOSIT, wage="5000", hours="40", bonus="500", reimbursement="20", invoice_number="INV-001", memo="Payment for consulting services")
...
| `wage`                                                                                                                                                                                                                       | *Optional[str]*                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                           | If the contractor is on a fixed wage, this is the fixed wage payment for the contractor, regardless of hours worked.                                                                                                         | 5000.00                                                                                                                                                                                                                      |
| `hours`                                                                                                                                                                                                                      | *Optional[str]*                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                           | If the contractor is on an hourly wage, this is the number of hours that the contractor worked for the payment.                                                                                                              | 40.5                                                                                                                                                                                                                         |
| `bonus`                                                                                                                                                                                                                      | *Optional[str]*                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                           | If the contractor is on an hourly wage, this is the bonus the contractor earned.                                                                                                                                             | 500.00                                                                                                                                                                                                                       |
| `reimbursement`                                                                                                                                                                                                              | *Optional[str]*                                                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                           | Reimbursed wages for the contractor.                                                                                                                                                                                         | 20.00                                                                                                                                                                                                                        |
...
with Gusto(
    ...
    res = gusto.contractor_payments.get(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.contractor_payments.delete(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.DeleteV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.preview(company_uuid="<id>", contractor_payments=[], x_gusto_api_version=gusto_embedded_v_2026_06_15.GetCompaniesCompanyUUIDContractorPaymentsPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.get_receipt(contractor_payment_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorPaymentsContractorPaymentUUIDReceiptHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.fund(contractor_payment_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1ContractorPaymentsContractorPaymentUUIDFundHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
