...
with Gusto(
    ...
    res = gusto.notifications.get_company_notifications(company_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetCompanyNotificationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.notifications.get_details(notification_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetNotificationsNotificationUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
