...
with Gusto(
    ...
    res = gusto.reverse_wire_transactions.get_reverse_wire_transactions(company_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetReverseWireTransactionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
