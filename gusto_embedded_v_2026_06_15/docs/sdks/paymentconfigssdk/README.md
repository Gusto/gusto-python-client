...
with Gusto(
    ...
    res = gusto.payment_configs.get(company_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1CompanyPaymentConfigsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.payment_configs.update(company_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.PutV1CompanyPaymentConfigsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
