...
with Gusto() as gusto:
    ...
    res = gusto.events.get(security=gusto_embedded_v_2026_06_15.GetEventsSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), x_gusto_api_version=gusto_embedded_v_2026_06_15.GetEventsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
