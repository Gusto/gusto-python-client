...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.list_subscriptions(security=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionsSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.create_subscription(security=gusto_embedded_v_2026_06_15.PostV1WebhookSubscriptionSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), url="https://slow-median.com", subscription_types=[
        gusto_embedded_v_2026_06_15.PostV1WebhookSubscriptionSubscriptionTypes.NOTIFICATION,
    ], x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1WebhookSubscriptionHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.get_subscription(security=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), webhook_subscription_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.update_subscription(security=gusto_embedded_v_2026_06_15.PutV1WebhookSubscriptionUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), webhook_subscription_uuid="<id>", subscription_types=[
        gusto_embedded_v_2026_06_15.PutV1WebhookSubscriptionUUIDSubscriptionTypes.PAY_SCHEDULE,
    ], x_gusto_api_version=gusto_embedded_v_2026_06_15.PutV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    gusto.webhooks.delete_subscription(security=gusto_embedded_v_2026_06_15.DeleteV1WebhookSubscriptionUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), webhook_subscription_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.DeleteV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.request_verification_token(security=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionVerificationTokenUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), webhook_subscription_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1WebhookSubscriptionVerificationTokenUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.verify(security=gusto_embedded_v_2026_06_15.PutV1VerifyWebhookSubscriptionUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), webhook_subscription_uuid="<id>", verification_token="<value>", x_gusto_api_version=gusto_embedded_v_2026_06_15.PutV1VerifyWebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.webhooks.get_v1_webhooks_health_check(security=gusto_embedded_v_2026_06_15.GetV1WebhooksHealthCheckSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1WebhooksHealthCheckHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
