...
with Gusto(
    ...
    res = gusto.salary_estimates.get_v1_salary_estimates_id(uuid="3c9d1f7e-adda-44fb-ba0e-7e5843661514", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.salary_estimates.put_v1_salary_estimates_id(uuid="969f5dac-57dd-4091-b195-2546171d3a76", zip_code="94107", occupations=[
        {
            "code": "151252",
            "experience_level": gusto_embedded_v_2026_06_15.PutV1SalaryEstimatesIDExperienceLevel.EXPERT,
            "time_percentage": "0.6",
            "primary": True,
        },
...
with Gusto() as gusto:
    ...
    res = gusto.salary_estimates.get_v1_salary_estimates_occupations(security=gusto_embedded_v_2026_06_15.GetV1SalaryEstimatesOccupationsSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), search="software", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1SalaryEstimatesOccupationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
