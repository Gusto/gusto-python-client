...
with Gusto(
    ...
    res = gusto.employee_payment_method.create(employee_id="<id>", routing_number="266905059", account_number="5809431207", account_type=gusto_embedded_v_2026_06_15.EmployeeBankAccountRequestAccountType.CHECKING, name="BoA Checking Account", x_gusto_api_version=gusto_embedded_v_2026_06_15.PostV1EmployeesEmployeeIDBankAccountsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.employee_payment_method.delete_bank_account(employee_id="<id>", bank_account_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.DeleteV1EmployeesEmployeeIDBankAccountsBankAccountIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.employee_payment_method.get(employee_id="<id>", x_gusto_api_version=gusto_embedded_v_2026_06_15.GetV1EmployeesEmployeeIDPaymentMethodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.employee_payment_method.update(employee_id="<id>", version="63859768485e218ccf8a449bb60f14ed", type_=gusto_embedded_v_2026_06_15.PutV1EmployeesEmployeeIDPaymentMethodType.CHECK, x_gusto_api_version=gusto_embedded_v_2026_06_15.PutV1EmployeesEmployeeIDPaymentMethodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
