...
class PaymentConfigsSDK(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompanyPaymentConfigsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompanyPaymentConfigsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
