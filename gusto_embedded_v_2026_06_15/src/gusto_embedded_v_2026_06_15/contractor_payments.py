...
class ContractorPayments(BaseSDK):
    def get_v1_contractors_contractor_uuid_payments(
        self,
        *,
        contractor_uuid: str,
        x_gusto_api_version: Optional[
            models.GetV1ContractorsContractorUUIDPaymentsHeaderXGustoAPIVersion
        ] = models.GetV1ContractorsContractorUUIDPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    ) -> List[models.ContractorPaymentListing]:
        r"""Get contractor payments
        ...
        :param sort_by: Sort the results. Format: `field` or `field:direction` where `field` is `check_date` or `created_at` and `direction` is `asc` or `desc`.
        ...
        request = models.GetV1ContractorsContractorUUIDPaymentsRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                List[models.ContractorPaymentListing], http_res
            )
    ...
    async def get_v1_contractors_contractor_uuid_payments_async(
        self,
        *,
        contractor_uuid: str,
        x_gusto_api_version: Optional[
    ...
    def get_v1_contractor_payments_contractor_payment_id_pdf(
        ...
        *,
        ...
        ] = models.GetV1ContractorPaymentsContractorPaymentIDPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ):
        r"""Get a contractor payment PDF
        ...
        request = models.GetV1ContractorPaymentsContractorPaymentIDPdfRequest(
            x_gusto_api_version=x_gusto_api_version,
        ...
        req = self._build_request(
            method="GET",
            path="/v1/contractor_payments/{contractor_payment_id}/pdf",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    async def get_v1_contractor_payments_contractor_payment_id_pdf_async(
        self,
        *,
        contractor_payment_id: str,
        x_gusto_api_version: Optional[
    ...
    def list(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        ...
        :param invoice_number: An optional invoice number to associate with this contractor payment. This will be visible to the contractor on their paystub. Maximum 25 characters.
        :param memo: An optional note or memo for this contractor payment. This will be visible to the contractor on their paystub.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.ContractorPaymentBody
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def preview(
        ...
        *,
        ...
        contractor_payments: Union[
            Iterable[models.ContractorPaymentsPreviewBodyContractorPayments],
            Iterable[models.ContractorPaymentsPreviewBodyContractorPaymentsTypedDict],
        ],
        x_gusto_api_version: Optional[
            models.GetCompaniesCompanyUUIDContractorPaymentsPreviewHeaderXGustoAPIVersion
        ] = models.GetCompaniesCompanyUUIDContractorPaymentsPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ContractorPaymentsPreview:
        ...
        :param contractor_payments: A list of contractor payments to preview.
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        request = models.GetCompaniesCompanyUUIDContractorPaymentsPreviewRequest(
            ...
            body=models.ContractorPaymentsPreviewBody(
                contractor_payments=utils.get_pydantic_model(
                    contractor_payments,
                    List[models.ContractorPaymentsPreviewBodyContractorPayments],
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.ContractorPaymentsPreviewBody
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ContractorPaymentsPreview, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectData, http_res
            )
    ...
    def get_receipt(
        ...
        *,
        ...
        ] = models.GetV1ContractorPaymentsContractorPaymentUUIDReceiptHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def fund(
        ...
        *,
        ...
        ] = models.GetV1ContractorPaymentsContractorPaymentUUIDFundHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
