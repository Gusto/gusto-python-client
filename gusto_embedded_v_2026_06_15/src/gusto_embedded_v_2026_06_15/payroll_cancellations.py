...
class PayrollCancellations(BaseSDK):
    def post_v1_payroll_batches(
        ...
        *,
        ...
        ] = models.PostV1PayrollBatchesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        ...
        request = models.PostV1PayrollBatchesRequest(
            ...
            body=models.PostV1PayrollBatchesRequestBody(
    ...
    def get_v1_payroll_batches_payroll_batch_uuid(
        ...
        *,
        ...
        ] = models.GetV1PayrollBatchesPayrollBatchUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
