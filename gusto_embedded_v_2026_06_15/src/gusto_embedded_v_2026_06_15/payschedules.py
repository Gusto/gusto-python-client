...
from gusto_embedded_v_2026_06_15.types import Nullable, OptionalNullable, UNSET
...
class PaySchedules(BaseSDK):
    def get_pay_periods(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayPeriodsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get_unprocessed_termination_periods(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDUnprocessedTerminationPayPeriodsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_all(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPaySchedulesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDPaySchedulesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        day_1: OptionalNullable[int] = UNSET,
        day_2: OptionalNullable[int] = UNSET,
        custom_name: OptionalNullable[str] = UNSET,
        workweek_start_day: Optional[models.WorkweekStartDay] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        :param company_id: The UUID of the company
        :param frequency:
        :param anchor_pay_date:
        :param anchor_end_of_pay_period:
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        ...
        :param custom_name: A custom pay schedule name; defaults to the pay frequency description when null or omitted.
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.PayScheduleCreateRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.PayScheduleShow, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectData, http_res
            )
    ...
    def get_preview(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPaySchedulesPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPaySchedulesPayScheduleIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPaySchedulesPayScheduleIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        auto_payroll: Optional[bool] = None,
        frequency: Optional[models.PayScheduleUpdateRequestFrequency] = None,
        anchor_pay_date: Optional[date] = None,
        anchor_end_of_pay_period: Optional[date] = None,
        day_1: OptionalNullable[int] = UNSET,
        day_2: OptionalNullable[int] = UNSET,
        custom_name: OptionalNullable[str] = UNSET,
        workweek_start_day: Optional[
            models.PayScheduleUpdateRequestWorkweekStartDay
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        :param auto_payroll: With automatic payroll enabled, payroll runs automatically one day before payroll deadlines. When false, payroll does not run automatically and must be run manually.
        ...
        :param custom_name: A custom pay schedule name; null clears any custom name so the default frequency description applies.
        :param workweek_start_day:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.PayScheduleUpdateRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def preview_assignment(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDPaySchedulesAssignmentPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.PayScheduleAssignmentBody
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def assign(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDPaySchedulesAssignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        hourly_pay_schedule_uuid: Optional[str] = None,
        salaried_pay_schedule_uuid: Optional[str] = None,
        default_pay_schedule_uuid: Optional[str] = None,
        partial_assignment: Optional[bool] = None,
    ...
    def get_assignments(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPaySchedulesAssignmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
