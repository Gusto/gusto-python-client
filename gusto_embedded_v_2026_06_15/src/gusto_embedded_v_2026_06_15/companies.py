...
from gusto_embedded_v_2026_06_15.suspensions import Suspensions
...
class Companies(BaseSDK):
    ...
    def create_admin(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDAdminsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_custom_fields(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDCustomFieldsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        page: Optional[int] = None,
        per: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def finish_onboarding(
        ...
        *,
        ...
        ] = models.GetV1CompanyFinishOnboardingHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def migrate(
        ...
        *,
        ...
        body: Union[
            ...
            models.PartnerManagedCompanyMigrateRequestTypedDict,
        ],
        x_gusto_api_version: Optional[
            models.PutV1PartnerManagedCompaniesCompanyUUIDMigrateHeaderXGustoAPIVersion
        ] = models.PutV1PartnerManagedCompaniesCompanyUUIDMigrateHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def create_partner_managed(
        ...
        *,
        ...
        ] = models.PostV1PartnerManagedCompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_v1_partner_managed_companies_company_uuid_migration_readiness(
        ...
        *,
        ...
        ] = models.GetV1PartnerManagedCompaniesCompanyUUIDMigrationReadinessHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def accept_terms_of_service(
        ...
        *,
        ...
        ] = models.PostPartnerManagedCompaniesCompanyUUIDAcceptTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ):
        r"""Accept terms of service for an admin
    ...
    def retrieve_terms_of_service(
        ...
        *,
        ...
        ] = models.PostPartnerManagedCompaniesCompanyUUIDRetrieveTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ):
        r"""Retrieve terms of service status for an admin
    ...
    def get_v1_partner_managed_companies_company_uuid_terms_of_service(
        self,
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[
            models.GetV1PartnerManagedCompaniesCompanyUUIDTermsOfServiceHeaderXGustoAPIVersion
        ] = models.GetV1PartnerManagedCompaniesCompanyUUIDTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PartnerManagedCompanyTermsOfServiceResponse:
        r"""Get the terms of service status for a company
    ...
    async def get_v1_partner_managed_companies_company_uuid_terms_of_service_async(
        self,
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[
    ...
    def put_v1_partner_managed_companies_company_uuid_terms_of_service(
        self,
        *,
        company_uuid: str,
        email: str,
        ...
        ] = models.PutV1PartnerManagedCompaniesCompanyUUIDTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PartnerManagedCompanyTermsOfServiceResponse:
        r"""Check terms of service status for a specific user
    ...
    async def put_v1_partner_managed_companies_company_uuid_terms_of_service_async(
        self,
        *,
        company_uuid: str,
        email: str,
    ...
    def post_v1_partner_managed_companies_company_uuid_terms_of_service(
        self,
        *,
        company_uuid: str,
        email: str,
        ...
        ] = models.PostV1PartnerManagedCompaniesCompanyUUIDTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.PartnerManagedCompanyTermsOfServiceResponse:
        r"""Accept terms of service for a specific user
    ...
    async def post_v1_partner_managed_companies_company_uuid_terms_of_service_async(
        self,
        *,
        company_uuid: str,
        email: str,
