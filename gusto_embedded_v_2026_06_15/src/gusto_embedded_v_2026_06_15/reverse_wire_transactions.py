...
class ReverseWireTransactions(BaseSDK):
    def get_reverse_wire_transactions(
        self,
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[
            models.GetReverseWireTransactionsHeaderXGustoAPIVersion
        ] = models.GetReverseWireTransactionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    ) -> List[models.ReverseWireTransaction]:
        r"""Get all reverse wire transactions for a company
        ...
        :param payroll_uuid: Filter results to reverse wires associated with a specific payroll
        ...
        request = models.GetReverseWireTransactionsRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/v1/companies/{company_uuid}/reverse_wire_transactions",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                tags=["Reverse Wire Transactions"],
                extensions={
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                List[models.ReverseWireTransaction], http_res
            )
    ...
    async def get_reverse_wire_transactions_async(
        self,
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[
