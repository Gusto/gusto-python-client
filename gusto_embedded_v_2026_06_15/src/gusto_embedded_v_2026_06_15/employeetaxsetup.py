...
class EmployeeTaxSetup(BaseSDK):
    def get_federal_taxes(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDFederalTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def update_federal_taxes(
        ...
        *,
        ...
        ] = models.PutV1EmployeesEmployeeIDFederalTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get_state_taxes(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDStateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
