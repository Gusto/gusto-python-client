...
class BulkReportCustomReportItemTypedDict(TypedDict):
    r"""A custom report entry in a bulk batch."""
    ...
    file_type: FileType
    r"""The type of file to generate."""
    report_type: Literal["custom_report"]
    r"""Identifies this batch item as a custom report."""
    groupings: NotRequired[List[Groupings]]
    r"""How to group the report. If omitted, defaults are derived from the requested `columns`."""
    custom_name: NotRequired[str]
    r"""Display name for the report."""
    with_totals: NotRequired[bool]
    r"""Whether to include subtotals and grand totals."""
    date_filter_type: NotRequired[DateFilterType]
    r"""Which payroll date `start_date` and `end_date` filter against."""
...
class BulkReportCustomReportItem(BaseModel):
    r"""A custom report entry in a bulk batch."""
    ...
    report_type: Annotated[
        Annotated[
            Literal["custom_report"], AfterValidator(validate_const("custom_report"))
        ],
        pydantic.Field(alias="report_type"),
    ] = "custom_report"
    r"""Identifies this batch item as a custom report."""

    groupings: Optional[List[Groupings]] = None
    r"""How to group the report. If omitted, defaults are derived from the requested `columns`."""
    ...
    date_filter_type: Optional[DateFilterType] = DateFilterType.PERIOD_END_DATE
    r"""Which payroll date `start_date` and `end_date` filter against."""
...
try:
    BulkReportCustomReportItem.model_rebuild()
except NameError:
    pass
