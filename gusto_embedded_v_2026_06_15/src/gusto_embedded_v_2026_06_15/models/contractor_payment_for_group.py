...
class ContractorPaymentForGroupPaymentMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentForGroupStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentForGroupWageType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentForGroup(BaseModel):
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentForGroupPaymentMethod(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentForGroupStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_wage_type(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentForGroupWageType(value)
            except ValueError:
                return value
        return value
