...
class PayrollDigests(BaseSDK):
    def post_v1_payroll_digests(
        ...
        *,
        ...
        ] = models.PostV1PayrollDigestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        ...
        request = models.PostV1PayrollDigestsRequest(
            ...
            body=models.PostV1PayrollDigestsRequestBody(
    ...
    def get_v1_payroll_digests_payroll_digest_uuid(
        ...
        *,
        ...
        ] = models.GetV1PayrollDigestsPayrollDigestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
