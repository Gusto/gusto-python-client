...
class FederalTaxDetailsSDK(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        ...
        **Setup:** [POST /v1/webhook_subscriptions](ref:post-v1-webhook-subscription) with `subscription_types`: `[\"Company\"]`
        ...
        if utils.match_response(http_res, "403", "application/json"):
            response_data = unmarshal_json_response(
                models.ForbiddenErrorObjectData, http_res
            )
            raise models.ForbiddenErrorObject(response_data, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectData, http_res
            )
