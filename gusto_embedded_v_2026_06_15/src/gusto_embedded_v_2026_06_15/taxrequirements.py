...
class TaxRequirements(BaseSDK):
    def get_all(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyUUIDTaxRequirementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyUUIDTaxRequirementsStateHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
