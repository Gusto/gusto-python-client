...
class Payrolls(BaseSDK):
    def generate_printable_checks(
        ...
        *,
        ...
        ] = models.PostV1PayrollsPayrollUUIDGeneratedDocumentsPrintablePayrollChecksHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get_pay_stubs(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeUUIDPayStubsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def get_pay_stub(
        ...
        *,
        ...
        ] = models.GetV1PayrollsPayrollUUIDEmployeesEmployeeUUIDPayStubHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if utils.match_response(http_res, "404", "application/json"):
            http_res_text = utils.stream_to_text(http_res)
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectData, http_res, http_res_text
            )
            raise models.NotFoundErrorObject(response_data, http_res, http_res_text)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def get_v1_companies_company_id_payrolls_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayrollsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def patch_v1_companies_company_id_payrolls_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.PatchV1CompaniesCompanyIDPayrollsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_approved_reversals(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayrollReversalsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        page: Optional[int] = None,
        per: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def create_off_cycle(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        pay_schedule_uuid: Optional[str] = None,
        employee_uuids: Optional[Iterable[str]] = None,
        ...
        :param employee_uuids: A list of employee UUIDs to include on the payroll. At least one UUID is required for non-termination off-cycle payrolls.
        ...
        request = models.PostV1CompaniesCompanyIDPayrollsRequest(
            ...
            body=models.PostV1CompaniesCompanyIDPayrollsRequestBody(
                ...
                employee_uuids=utils.unmarshal(employee_uuids, Optional[List[str]]),
    ...
    def get_receipt(
        ...
        *,
        ...
        ] = models.GetV1PaymentReceiptsPayrollsPayrollUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        page: Optional[int] = None,
        per: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def cancel(
        ...
        *,
        ...
        ] = models.PutAPIV1CompaniesCompanyIDPayrollsPayrollIDCancelHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def prepare(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPayrollsPayrollIDPrepareHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        page: Optional[int] = None,
        per: Optional[int] = None,
        sort_by: Optional[str] = None,
    ...
    def calculate(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPayrollsPayrollIDCalculateHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_blockers(
        ...
        *,
        ...
        ] = models.GetV1CompaniesPayrollBlockersCompanyUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def skip(
        ...
        *,
        ...
        ] = models.PostCompaniesPayrollSkipCompanyUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        start_date: Optional[str] = None,
        end_date: Optional[str] = None,
        pay_schedule_uuid: Optional[str] = None,
        employee_uuids: OptionalNullable[Iterable[str]] = UNSET,
    ...
    def submit(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPayrollsPayrollIDSubmitHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def calculate_gross_up(
        ...
        *,
        ...
        ] = models.PostPayrollsGrossUpPayrollUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
