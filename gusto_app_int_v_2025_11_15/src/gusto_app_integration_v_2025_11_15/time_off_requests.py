...
class TimeOffRequests(BaseSDK):
    def get_v1_companies_company_id_time_off_requests(
        self,
        *,
        company_id: str,
        x_gusto_api_version: Optional[
            models.GetV1CompaniesCompanyIDTimeOffRequestsHeaderXGustoAPIVersion
        ] = models.GetV1CompaniesCompanyIDTimeOffRequestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    ) -> List[models.TimeOffRequest]:
        r"""Get time off requests for a company
        ...
        :param company_id: The company UUID
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        :param start_date: Filter time off requests starting on or after this date
        :param end_date: Filter time off requests ending on or before this date
        ...
        request = models.GetV1CompaniesCompanyIDTimeOffRequestsRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/v1/companies/{company_id}/time_off_requests",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.TimeOffRequest], http_res)
    ...
    async def get_v1_companies_company_id_time_off_requests_async(
        self,
        *,
        company_id: str,
        x_gusto_api_version: Optional[
