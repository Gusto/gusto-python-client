...
class DeductionReducesTaxableIncome(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EmployeeBenefit(BaseModel):
    ...
    @field_serializer("deduction_reduces_taxable_income")
    def serialize_deduction_reduces_taxable_income(self, value):
        if isinstance(value, str):
            try:
                return models.DeductionReducesTaxableIncome(value)
            except ValueError:
                return value
        return value
