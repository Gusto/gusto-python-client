...
class PutV1EmployeesHeaderXGustoAPIVersion(str, Enum):
...
class PutV1EmployeesRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["middle_initial", "preferred_first_name"])
...
class PutV1EmployeesRequestTypedDict(TypedDict):
    ...
    body: PutV1EmployeesRequestBodyTypedDict
    x_gusto_api_version: NotRequired[PutV1EmployeesHeaderXGustoAPIVersion]
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
...
class PutV1EmployeesRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[PutV1EmployeesHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = PutV1EmployeesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
