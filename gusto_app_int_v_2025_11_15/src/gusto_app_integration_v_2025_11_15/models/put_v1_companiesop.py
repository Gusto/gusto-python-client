...
class PutV1CompaniesHeaderXGustoAPIVersion(str, Enum):
...
class PutV1CompaniesRequestTypedDict(TypedDict):
    ...
    body: PutV1CompaniesRequestBodyTypedDict
    x_gusto_api_version: NotRequired[PutV1CompaniesHeaderXGustoAPIVersion]
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
...
class PutV1CompaniesRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[PutV1CompaniesHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = PutV1CompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
