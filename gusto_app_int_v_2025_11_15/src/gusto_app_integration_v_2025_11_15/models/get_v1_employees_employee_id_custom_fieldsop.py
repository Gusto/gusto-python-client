...
class GetV1EmployeesEmployeeIDCustomFieldsHeaderXGustoAPIVersion(str, Enum):
...
class GetV1EmployeesEmployeeIDCustomFieldsRequest(BaseModel):
    ...
    ] = GetV1EmployeesEmployeeIDCustomFieldsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
