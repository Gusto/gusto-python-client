...
class EmployeeOnboardingStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EmployeePaymentMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EmployeeCurrentEmploymentStatus(str, Enum, metaclass=utils.OpenEnumMeta):
    FULL_TIME = "full_time"
...
class Employee(BaseModel):
    ...
    def serialize_onboarding_status(self, value):
        if isinstance(value, str):
            try:
                return models.EmployeeOnboardingStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.EmployeePaymentMethod(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_current_employment_status(self, value):
        if isinstance(value, str):
            try:
                return models.EmployeeCurrentEmploymentStatus(value)
            except ValueError:
                return value
        return value
