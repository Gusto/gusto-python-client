...
class PutV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion(str, Enum):
...
class PutV1HomeAddressesHomeAddressUUIDRequestTypedDict(TypedDict):
    ...
    body: PutV1HomeAddressesHomeAddressUUIDRequestBodyTypedDict
...
class PutV1HomeAddressesHomeAddressUUIDRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[PutV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = PutV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
...
try:
    PutV1HomeAddressesHomeAddressUUIDRequestBody.model_rebuild()
except NameError:
    pass
