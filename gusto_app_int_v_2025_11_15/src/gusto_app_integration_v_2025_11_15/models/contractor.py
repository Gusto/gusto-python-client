...
class ContractorType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorOnboardingStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorMemberPortalInvitationStatus(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorStatus(value)
            except ValueError:
                return value
        return value
...
class Contractor(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_onboarding_status(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorOnboardingStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentMethod(value)
            except ValueError:
                return value
        return value
