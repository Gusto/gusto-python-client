...
class ContractorCreateRequestBodyType(str, Enum):
...
class ContractorCreateRequestBodyWageType(str, Enum):
...
class ContractorCreateRequestBodyTypedDict(TypedDict):
    r"""Request body for creating a contractor."""

    wage_type: ContractorCreateRequestBodyWageType
    r"""The contractor’s wage type.
    ...
    """
    type: NotRequired[ContractorCreateRequestBodyType]
    r"""The contractor type."""
...
class ContractorCreateRequestBody(BaseModel):
    r"""Request body for creating a contractor."""
    ...
    type: Optional[ContractorCreateRequestBodyType] = (
        ContractorCreateRequestBodyType.INDIVIDUAL
    )
    r"""The contractor type."""
