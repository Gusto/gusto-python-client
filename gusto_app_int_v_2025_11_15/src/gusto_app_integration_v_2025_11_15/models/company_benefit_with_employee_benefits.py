...
class CompanyBenefitWithEmployeeBenefitsSource(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CompanyBenefitWithEmployeeBenefits(BaseModel):
    ...
    def serialize_source(self, value):
        if isinstance(value, str):
            try:
                return models.CompanyBenefitWithEmployeeBenefitsSource(value)
            except ValueError:
                return value
        return value

    @field_serializer("catch_up_type")
    def serialize_catch_up_type(self, value):
        if isinstance(value, str):
            try:
                return models.CompanyBenefitWithEmployeeBenefitsCatchUpType(value)
            except ValueError:
                return value
        return value
