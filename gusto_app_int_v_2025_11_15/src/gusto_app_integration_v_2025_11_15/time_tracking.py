...
class TimeTracking(BaseSDK):
    def get_companies_company_uuid_time_tracking_time_sheets(
        ...
        *,
        ...
        ] = models.GetCompaniesCompanyUUIDTimeTrackingTimeSheetsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        sort_by: Optional[
            models.GetCompaniesCompanyUUIDTimeTrackingTimeSheetsQueryParamSortBy
        ] = None,
        sort_order: Optional[
            models.GetCompaniesCompanyUUIDTimeTrackingTimeSheetsQueryParamSortOrder
        ] = None,
        ...
        :param after: time sheets that were created after ISO 8601 timestamp. Filtering by \"created_at\"
    ...
    def post_companies_company_uuid_time_tracking_time_sheets(
        ...
        *,
        ...
        ] = models.PostCompaniesCompanyUUIDTimeTrackingTimeSheetsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PostCompaniesCompanyUUIDTimeTrackingTimeSheetsRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            body=models.TimeSheetCreateBody(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.TimeSheetCreateBody
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def get_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        time_sheet_uuid: str,
        x_gusto_api_version: Optional[
            models.GetTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion
        ] = models.GetTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def put_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        ...
        version: str,
        x_gusto_api_version: Optional[
            models.PutTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion
        ] = models.PutTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PutTimeTrackingTimeSheetsTimeSheetUUIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            time_sheet_uuid=time_sheet_uuid,
            body=models.TimeSheetUpdateBody(
                version=version,
                entity_uuid=entity_uuid,
                entity_type=entity_type,
                job_uuid=job_uuid,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.TimeSheetUpdateBody
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def delete_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        ...
        version: str,
        x_gusto_api_version: Optional[
            models.DeleteTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion
        ] = models.DeleteTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def post_companies_company_uuid_time_tracking_payroll_syncs(
        ...
        *,
        ...
        ] = models.PostCompaniesCompanyUUIDTimeTrackingPayrollSyncsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        **To track completion:**
        ...
        request = models.PostCompaniesCompanyUUIDTimeTrackingPayrollSyncsRequest(
            ...
            body=models.PayrollSyncCreateRequestBody(
                kind=kind,
    ...
    def get_time_tracking_payroll_syncs_payroll_sync_uuid(
        ...
        *,
        ...
        ] = models.GetTimeTrackingPayrollSyncsPayrollSyncUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
