...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.contractor_payments.get(company_id="<id>", start_date="2020-01-01", end_date="2020-12-31", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.contractor_payments.get_by_id(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
