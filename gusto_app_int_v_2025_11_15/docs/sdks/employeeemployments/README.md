...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.employee_employments.create_termination(employee_id="<id>", effective_date="2020-06-30", x_gusto_api_version=gusto_app_integration_v_2025_11_15.PostV1EmployeesEmployeeIDTerminationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15, run_termination_payroll=False)
...
with GustoAppIntegration(
    ...
    gusto_app_integration.employee_employments.delete_termination(employee_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.DeleteV1EmployeesEmployeeIDTerminationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.employee_employments.update_termination(employee_id="<id>", version="d487dd0b55dfcacdd920ccbdaeafa351", effective_date="2020-06-30", x_gusto_api_version=gusto_app_integration_v_2025_11_15.PutV1TerminationsEmployeeIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15, run_termination_payroll=False)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.employee_employments.get_rehire(employee_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    gusto_app_integration.employee_employments.delete_rehire(employee_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.DeleteV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.employee_employments.get_history(employee_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1EmployeesEmployeeIDEmploymentHistoryHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.employee_employments.get_v1_terminations_employee_id(employee_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1TerminationsEmployeeIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
