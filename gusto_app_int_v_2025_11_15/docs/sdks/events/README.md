...
with GustoAppIntegration() as gusto_app_integration:
    ...
    res = gusto_app_integration.events.get_all(security=gusto_app_integration_v_2025_11_15.GetEventsSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetEventsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| `sort_order`                                                                                                                                                                                                                 | [Optional[models.QueryParamSortOrder]](../../models/queryparamsortorder.md)                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                                           | A string indicating whether to sort resulting events in ascending (asc) or descending (desc) chronological order. Events are sorted by their `timestamp`. Defaults to asc if left empty.                                     |
