...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.reports.post_payrolls_payroll_uuid_reports_general_ledger(payroll_uuid="<id>", aggregation=gusto_app_integration_v_2025_11_15.Aggregation.DEFAULT, x_gusto_api_version=gusto_app_integration_v_2025_11_15.PostPayrollsPayrollUUIDReportsGeneralLedgerHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.reports.get_reports_request_uuid(request_uuid="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetReportsRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.reports.post_v1_companies_company_id_reports_employees_annual_fica_wage(company_id="<id>", start_year=2023, end_year=2024, x_gusto_api_version=gusto_app_integration_v_2025_11_15.PostV1CompaniesCompanyIDReportsEmployeesAnnualFicaWageHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
