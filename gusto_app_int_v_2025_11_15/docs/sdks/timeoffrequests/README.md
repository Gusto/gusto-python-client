...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.time_off_requests.get_v1_companies_company_id_time_off_requests(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2025_11_15.GetV1CompaniesCompanyIDTimeOffRequestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
