...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [gusto_app_integration_v_2025_11_15](#gustoappintegrationv20251115)
...
### [CompanyLocations](docs/sdks/companylocations/README.md)

* [list](docs/sdks/companylocations/README.md#list) - Get all company locations
...
[`GustoAppIntegrationError`](./src/gusto_app_integration_v_2025_11_15/models/gustoappintegrationerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`GustoAppIntegrationError`](./src/gusto_app_integration_v_2025_11_15/models/gustoappintegrationerror.py): The base class for HTTP error responses.
  * [`NotFoundErrorObject`](./src/gusto_app_integration_v_2025_11_15/models/notfounderrorobject.py): Not Found     The requested resource does not exist. Make sure the provided ID/UUID is valid. *
...
**Inherit from [`GustoAppIntegrationError`](./src/gusto_app_integration_v_2025_11_15/models/gustoappintegrationerror.py)**:
* [`UnprocessableEntityErrorObject`](./src/gusto_app_integration_v_2025_11_15/models/unprocessableentityerrorobject.py): Unprocessable Entity    This may happen when the body of your request contains errors such as `invalid_attribute_value`, or the request fails due to an `invalid_operation`. See the [Errors Categories](https://docs.gusto.com/embedded-payroll/docs/error-categories) guide for more details. Applicable to 63 of 137 methods.*
* [`ConflictErrorObject`](./src/gusto_app_integration_v_2025_11_15/models/conflicterrorobject.py): Conflict    This error occurs when the resource version provided does not match the current version. Retrieve the latest version and retry. Status code `409`. Applicable to 1 of 137 methods.*
* [`ResponseValidationError`](./src/gusto_app_integration_v_2025_11_15/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
