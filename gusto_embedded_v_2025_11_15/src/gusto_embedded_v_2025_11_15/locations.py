...
class Locations(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDLocationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDLocationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.CompanyLocationRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def retrieve(
        ...
        *,
        ...
        ] = models.GetV1LocationsLocationIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1LocationsLocationIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PutV1LocationsLocationIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            location_id=location_id,
            body=models.PutV1LocationsLocationIDRequestBody(
                version=version,
                phone_number=phone_number,
                street_1=street_1,
                street_2=street_2,
    ...
    def get_minimum_wages(
        ...
        *,
        ...
        ] = models.GetV1LocationsLocationUUIDMinimumWagesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
