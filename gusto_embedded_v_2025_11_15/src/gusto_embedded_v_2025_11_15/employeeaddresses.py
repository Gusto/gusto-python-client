...
class EmployeeAddresses(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDHomeAddressesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.EmployeeAddress], http_res)
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1EmployeesEmployeeIDHomeAddressesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.EmployeeAddress, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectErrorData, http_res
            )
    ...
    def retrieve_home_address(
        ...
        *,
        ...
        ] = models.GetV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        street_1: Optional[str] = None,
        street_2: OptionalNullable[str] = UNSET,
        city: Optional[str] = None,
        state: Optional[str] = None,
        ...
        request = models.PutV1HomeAddressesHomeAddressUUIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            home_address_uuid=home_address_uuid,
            body=models.PutV1HomeAddressesHomeAddressUUIDRequestBody(
                version=version,
                street_1=street_1,
                street_2=street_2,
                city=city,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1HomeAddressesHomeAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_work_addresses(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDWorkAddressesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.EmployeeWorkAddress], http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectErrorData, http_res
            )
    ...
    def create_work_address(
        ...
        *,
        ...
        ] = models.PostV1EmployeesEmployeeIDWorkAddressesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.EmployeeWorkAddress, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectErrorData, http_res
            )
    ...
    def retrieve_work_address(
        ...
        *,
        ...
        ] = models.GetV1WorkAddressesWorkAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update_work_address(
        ...
        *,
        ...
        ] = models.PutV1WorkAddressesWorkAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        location_uuid: Optional[str] = None,
        effective_date: Optional[date] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def delete_work_address(
        ...
        *,
        ...
        ] = models.DeleteV1WorkAddressesWorkAddressUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
