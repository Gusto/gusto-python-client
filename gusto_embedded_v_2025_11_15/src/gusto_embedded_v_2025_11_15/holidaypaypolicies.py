...
class HolidayPayPolicies(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PostV1CompaniesCompanyUUIDHolidayPayPolicyRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            body=models.HolidayPayPolicyRequest(
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        federal_holidays: Optional[
            Union[
        ...
        request = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            body=models.PutV1CompaniesCompanyUUIDHolidayPayPolicyRequestBody(
                version=version,
                federal_holidays=utils.get_pydantic_model(
                    federal_holidays,
                    Optional[
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def add_employees(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyAddHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyAddRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            body=models.PutV1CompaniesCompanyUUIDHolidayPayPolicyAddRequestBody(
                version=version,
    ...
    def remove_employees(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyRemoveHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PutV1CompaniesCompanyUUIDHolidayPayPolicyRemoveRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            body=models.PutV1CompaniesCompanyUUIDHolidayPayPolicyRemoveRequestBody(
                version=version,
                employees=utils.get_pydantic_model(
                    employees,
                    List[
    ...
    def preview_paid_holidays(
        ...
        *,
        ...
        ] = models.GetCompaniesCompanyUUIDPaidHolidaysHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
