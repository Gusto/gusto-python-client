...
class WireInRequests(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetWireInRequestsWireInRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.WireInRequest, http_res)
    ...
    def submit(
        ...
        *,
        ...
        ] = models.PutWireInRequestsWireInRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.WireInRequestUpdateRequestBody,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def list(
        ...
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[
            models.GetCompaniesCompanyUUIDWireInRequestUUIDHeaderXGustoAPIVersion
        ] = models.GetCompaniesCompanyUUIDWireInRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.WireInRequest], http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
