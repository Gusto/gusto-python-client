...
class ContractorForms(BaseSDK):
    def list(
        ...
        *,
        ...
        ] = models.GetV1ContractorFormsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.Form1099], http_res)
    ...
    def get(
        ...
        *,
        ...
        form_id: str,
        x_gusto_api_version: Optional[
            models.GetV1ContractorFormHeaderXGustoAPIVersion
        ] = models.GetV1ContractorFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.Form1099, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectErrorData, http_res
            )
    ...
    def get_pdf(
        ...
        *,
        ...
        form_id: str,
        x_gusto_api_version: Optional[
            models.GetV1ContractorFormPdfHeaderXGustoAPIVersion
        ] = models.GetV1ContractorFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def generate1099(
        ...
        *,
        ...
        ] = models.PostV1SandboxGenerate1099HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PostV1SandboxGenerate1099Request(
            x_gusto_api_version=x_gusto_api_version,
            body=models.PostV1SandboxGenerate1099RequestBody(
