...
class PostCompaniesPayrollSkipCompanyUUIDRequestBodyTypedDict(TypedDict):
    ...
    r"""Pay period end date. If left empty, defaults to today's date. Required when skipping a termination payroll (`payroll_type` = `Dismissed employee`)."""
    pay_schedule_uuid: NotRequired[str]
    r"""The UUID of the pay schedule. Required when skipping a termination payroll (`payroll_type` = `Dismissed employee`)."""
...
class PostCompaniesPayrollSkipCompanyUUIDRequestTypedDict(TypedDict):
    ...
    body: PostCompaniesPayrollSkipCompanyUUIDRequestBodyTypedDict
...
class PostCompaniesPayrollSkipCompanyUUIDRequest(BaseModel):
    ...
    ] = PostCompaniesPayrollSkipCompanyUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
