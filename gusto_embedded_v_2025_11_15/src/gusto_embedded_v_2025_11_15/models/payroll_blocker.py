...
class Key(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""A unique identifier for the payroll blocker reason. For a complete list of blockers and their meanings, see the [Payroll Blockers guide](https://docs.gusto.com/embedded-payroll/docs/payroll-blockers)."""
...
class PayrollBlockerTypedDict(TypedDict):
    ...
    r"""A unique identifier for the payroll blocker reason. For a complete list of blockers and their meanings, see the [Payroll Blockers guide](https://docs.gusto.com/embedded-payroll/docs/payroll-blockers)."""
    message: str
    r"""A human-readable message describing the payroll blocker and what action is needed to resolve it."""
