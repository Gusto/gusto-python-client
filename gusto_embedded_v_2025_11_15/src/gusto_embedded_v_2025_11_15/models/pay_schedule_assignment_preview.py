...
class PayScheduleAssignmentPreviewType(str, Enum, metaclass=utils.OpenEnumMeta):
    SINGLE = "single"
...
class PayScheduleAssignmentPreview(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.PayScheduleAssignmentPreviewType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_model(self, handler):
        optional_fields = set(["type", "employee_changes"])
