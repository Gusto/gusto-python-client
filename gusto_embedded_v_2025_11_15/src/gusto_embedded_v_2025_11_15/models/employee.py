...
class EmployeeOnboardingStatus1(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EmployeePaymentMethod1(str, Enum, metaclass=utils.OpenEnumMeta):
...
class Employee(BaseModel):
    ...
    def serialize_onboarding_status(self, value):
        if isinstance(value, str):
            try:
                return models.EmployeeOnboardingStatus1(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.EmployeePaymentMethod1(value)
            except ValueError:
                return value
        return value
