...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDHeaderXGustoAPIVersion(str, Enum):
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""

    TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15 = "2025-11-15"


class PutV1TimeOffPoliciesTimeOffPolicyUUIDPolicyType(str, Enum):
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDAccrualMethod(str, Enum):
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestBodyTypedDict(TypedDict):
    r"""Request body for updating a time off policy"""
    ...
    policy_type: NotRequired[PutV1TimeOffPoliciesTimeOffPolicyUUIDPolicyType]
    r"""Type of the time off policy. Currently only \"vacation\" and \"sick\" are supported"""
    accrual_method: NotRequired[PutV1TimeOffPoliciesTimeOffPolicyUUIDAccrualMethod]
    r"""Accrual method of the time off policy"""
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestBody(BaseModel):
    r"""Request body for updating a time off policy"""
    ...
    policy_type: Optional[PutV1TimeOffPoliciesTimeOffPolicyUUIDPolicyType] = None
    r"""Type of the time off policy. Currently only \"vacation\" and \"sick\" are supported"""

    accrual_method: Optional[PutV1TimeOffPoliciesTimeOffPolicyUUIDAccrualMethod] = None
    r"""Accrual method of the time off policy"""
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestTypedDict(TypedDict):
    time_off_policy_uuid: str
    r"""The UUID of the time off policy"""
    body: PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestBodyTypedDict
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[PutV1TimeOffPoliciesTimeOffPolicyUUIDHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = PutV1TimeOffPoliciesTimeOffPolicyUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
