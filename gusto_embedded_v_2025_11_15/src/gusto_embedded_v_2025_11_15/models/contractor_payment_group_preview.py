...
class ContractorPaymentGroupPreviewStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentGroupPreview(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentGroupPreviewStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["uuid", "creation_token", "partner_owned_disbursement"])
        serialized = handler(self)
        m = {}
