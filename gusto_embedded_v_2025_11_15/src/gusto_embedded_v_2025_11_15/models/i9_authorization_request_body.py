...
class I9AuthorizationRequestBodyAuthorizationStatus(str, Enum):
...
class I9AuthorizationRequestBodyDocumentType(str, Enum):
...
class I9AuthorizationRequestBodyTypedDict(TypedDict):
    r"""Request body for creating or updating an employee's I-9 authorization."""

    authorization_status: I9AuthorizationRequestBodyAuthorizationStatus
    r"""The employee's authorization status.
    - `citizen`: A citizen is someone who was born in the United States or is a naturalized citizen living in the United States.
    - `noncitizen`: A noncitizen national is someone born in American Samoa, certain former citizens of the former Trust Territory of the Pacific Islands, and certain children of noncitizen nationals born abroad.
    - `permanent_resident`: A lawful permanent resident is someone who is not a US citizen and who resides under legally recognized and lawfully recorded permanent residence as an immigrant.
    ...
    r"""The current version of the object. See the [versioning guide](https://docs.gusto.com/embedded-payroll/docs/idempotency) for information on how to use this field. If supplied, this endpoint will update the existing I-9 authorization if it exists."""
    document_type: NotRequired[I9AuthorizationRequestBodyDocumentType]
    r"""The type of document an employee holds, based on their authorization status.
    - This is unused for authorization status `citizen` or `noncitizen`.
    - If the authorization status is `permanent_resident`, this must be `uscis_alien_registration_number`.
    - If the authorization status is `alien`, this is required and may be any of the valid values.
...
class I9AuthorizationRequestBody(BaseModel):
    r"""Request body for creating or updating an employee's I-9 authorization."""
    ...
    document_type: Optional[I9AuthorizationRequestBodyDocumentType] = None
    r"""The type of document an employee holds, based on their authorization status.
    - This is unused for authorization status `citizen` or `noncitizen`.
    - If the authorization status is `permanent_resident`, this must be `uscis_alien_registration_number`.
    - If the authorization status is `alien`, this is required and may be any of the valid values.
