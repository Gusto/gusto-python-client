...
class PutV1EmployeeFormSignHeaderXGustoAPIVersion(str, Enum):
...
class PutV1EmployeeFormSignRequestTypedDict(TypedDict):
    ...
    body: PutV1EmployeeFormSignRequestBodyTypedDict
    x_gusto_api_version: NotRequired[PutV1EmployeeFormSignHeaderXGustoAPIVersion]
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
...
class PutV1EmployeeFormSignRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[PutV1EmployeeFormSignHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = PutV1EmployeeFormSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
