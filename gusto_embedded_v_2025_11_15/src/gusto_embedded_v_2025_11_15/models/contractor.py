...
class ContractorOnboardingStatus1(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ContractorPaymentMethod1(str, Enum, metaclass=utils.OpenEnumMeta):
...
class Contractor(BaseModel):
    ...
    def serialize_onboarding_status(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorOnboardingStatus1(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.ContractorPaymentMethod1(value)
            except ValueError:
                return value
        return value
