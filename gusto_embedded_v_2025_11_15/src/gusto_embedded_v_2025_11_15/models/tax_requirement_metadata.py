...
class TaxRequirementMetadataType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RateType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class TaxRequirementMetadataValidationType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class Validation(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.TaxRequirementMetadataValidationType(value)
            except ValueError:
                return value
        return value
...
class TaxRequirementMetadata(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.TaxRequirementMetadataType(value)
            except ValueError:
                return value
        return value

    @field_serializer("rate_type")
    def serialize_rate_type(self, value):
        if isinstance(value, str):
            try:
                return models.RateType(value)
            except ValueError:
                return value
        return value
