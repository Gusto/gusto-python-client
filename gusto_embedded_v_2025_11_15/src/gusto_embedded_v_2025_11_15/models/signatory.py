...
class IdentityVerificationStatus(str, Enum, metaclass=utils.OpenEnumMeta):
    PASS = "Pass"
    FAIL = "Fail"
    SKIPPED = "Skipped"
...
class Signatory(BaseModel):
    ...
    @field_serializer("identity_verification_status")
    def serialize_identity_verification_status(self, value):
        if isinstance(value, str):
            try:
                return models.IdentityVerificationStatus(value)
            except ValueError:
                return value
        return value
