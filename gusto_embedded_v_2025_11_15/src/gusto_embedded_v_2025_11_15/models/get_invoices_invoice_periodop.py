...
class GetInvoicesInvoicePeriodHeaderXGustoAPIVersion(str, Enum):
...
class GetInvoicesInvoicePeriodRequestTypedDict(TypedDict):
    ...
    x_gusto_api_version: NotRequired[GetInvoicesInvoicePeriodHeaderXGustoAPIVersion]
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
...
class GetInvoicesInvoicePeriodRequest(BaseModel):
    ...
    x_gusto_api_version: Annotated[
        Optional[GetInvoicesInvoicePeriodHeaderXGustoAPIVersion],
        pydantic.Field(alias="X-Gusto-API-Version"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = GetInvoicesInvoicePeriodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["X-Gusto-API-Version", "page", "per", "company_uuids"])
