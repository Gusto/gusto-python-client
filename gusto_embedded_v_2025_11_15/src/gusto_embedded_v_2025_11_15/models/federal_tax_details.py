...
class TaxPayerType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class FilingForm(str, Enum, metaclass=utils.OpenEnumMeta):
...
class FederalTaxDetailsStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EinVerification(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.FederalTaxDetailsStatus(value)
            except ValueError:
                return value
        return value
...
class FederalTaxDetailsTypedDict(TypedDict):
    ...
    tax_payer_type: NotRequired[Nullable[TaxPayerType]]
...
class FederalTaxDetails(BaseModel):
    ...
    tax_payer_type: OptionalNullable[TaxPayerType] = UNSET
    r"""What type of tax entity the company is. One of:
    - C-Corporation
    - S-Corporation
    - Sole proprietor
    ...
    @field_serializer("tax_payer_type")
    def serialize_tax_payer_type(self, value):
        if isinstance(value, str):
            try:
                return models.TaxPayerType(value)
            except ValueError:
                return value
        return value

    @field_serializer("filing_form")
    def serialize_filing_form(self, value):
        if isinstance(value, str):
            try:
                return models.FilingForm(value)
            except ValueError:
                return value
        return value
