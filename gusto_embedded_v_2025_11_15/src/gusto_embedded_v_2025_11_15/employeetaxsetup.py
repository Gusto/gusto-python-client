...
class EmployeeTaxSetup(BaseSDK):
    def get_federal_taxes(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDFederalTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def update_federal_taxes(
        ...
        *,
        ...
        ] = models.PutV1EmployeesEmployeeIDFederalTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PutV1EmployeesEmployeeIDFederalTaxesRequest(
            x_gusto_api_version=x_gusto_api_version,
            employee_uuid=employee_uuid,
            body=models.PutV1EmployeesEmployeeIDFederalTaxesRequestBody(
                version=version,
    ...
    def get_state_taxes(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDStateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update_state_taxes(
        ...
        *,
        ...
        ] = models.PutV1EmployeesEmployeeIDStateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.EmployeeStateTaxesRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
