    ...
    def get(
        ...
        *,
        ...
        x_gusto_api_version: Optional[
            models.GetInvoicesInvoicePeriodHeaderXGustoAPIVersion
        ] = models.GetInvoicesInvoicePeriodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.InvoiceData, http_res)
