...
class CompanyForms(BaseSDK):
    def get_all(
        ...
        *,
        ...
        ] = models.GetV1CompanyFormsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        sort_by: Optional[models.GetV1CompanyFormsQueryParamSortBy] = None,
        ...
        :param sort_by: Sort company forms by a given field. Append `:asc` or `:desc` to specify direction (e.g., `name:asc`). Defaults to ascending.
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompanyFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_pdf(
        ...
        *,
        form_id: str,
        x_gusto_api_version: Optional[
            models.GetV1CompanyFormPdfHeaderXGustoAPIVersion
        ] = models.GetV1CompanyFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def sign(
        ...
        *,
        ...
        ] = models.PutV1CompanyFormSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PutV1CompanyFormSignRequest(
            ...
            body=models.PutV1CompanyFormSignRequestBody(
