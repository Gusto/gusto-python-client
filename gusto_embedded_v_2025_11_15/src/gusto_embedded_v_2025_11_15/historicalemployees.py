    ...
    def update(
        ...
        *,
        ...
        x_gusto_api_version: Optional[
            models.PutV1HistoricalEmployeesHeaderXGustoAPIVersion
        ] = models.PutV1HistoricalEmployeesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        :param historical_employee_uuid: The UUID of the historical employee returned from create or list responses.
        ...
        request = models.PutV1HistoricalEmployeesRequest(
            ...
            body=models.PutV1HistoricalEmployeesRequestBody(
                version=version,
