...
class EarningTypes(BaseSDK):
    def list(
        ...
        *,
        ...
        x_gusto_api_version: Optional[
            models.GetV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion
        ] = models.GetV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.EarningTypeList, http_res)
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.EarningType, http_res)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                models.NotFoundErrorObjectErrorData, http_res
            )
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def delete(
        ...
        *,
        ...
        earning_type_uuid: str,
        x_gusto_api_version: Optional[
            models.DeleteV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion
        ] = models.DeleteV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
