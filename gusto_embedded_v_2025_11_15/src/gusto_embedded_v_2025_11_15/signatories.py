...
class Signatories(BaseSDK):
    def list(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyUUIDSignatoriesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ssn: str,
        home_address: Union[
            models.SignatoryCreateRequestHomeAddress,
            models.SignatoryCreateRequestHomeAddressTypedDict,
        ],
        x_gusto_api_version: Optional[
            models.PostV1CompanySignatoriesHeaderXGustoAPIVersion
        ] = models.PostV1CompanySignatoriesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PostV1CompanySignatoriesRequest(
            ...
            body=models.SignatoryCreateRequest(
                ...
                home_address=utils.get_pydantic_model(
                    home_address, models.SignatoryCreateRequestHomeAddress
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.SignatoryCreateRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def invite(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyUUIDSignatoriesInviteHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        middle_initial: Optional[str] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.SignatoryInviteRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyUUIDSignatoriesSignatoryUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.SignatoryUpdateRequest
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyUUIDSignatoriesSignatoryUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
