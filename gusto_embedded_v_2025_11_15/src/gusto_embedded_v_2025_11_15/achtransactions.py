...
class AchTransactions(BaseSDK):
    def get_all(
        ...
        *,
        ...
        ] = models.GetAchTransactionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.AchTransaction], http_res)
