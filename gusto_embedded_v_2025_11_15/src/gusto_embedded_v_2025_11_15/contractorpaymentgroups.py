...
class ContractorPaymentGroups(BaseSDK):
    def get_list(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDContractorPaymentGroupsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDContractorPaymentGroupsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        :param creation_token: A token used to make contractor payment group creation idempotent. The string must be unique for each group you intend to create.
        ...
        request = models.PostV1CompaniesCompanyIDContractorPaymentGroupsRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_id=company_id,
            body=models.PostV1CompaniesCompanyIDContractorPaymentGroupsRequestBody(
    ...
    def preview(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDContractorPaymentGroupsPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        request = models.PostV1CompaniesCompanyIDContractorPaymentGroupsPreviewRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_id=company_id,
            body=models.PostV1CompaniesCompanyIDContractorPaymentGroupsPreviewRequestBody(
                contractor_payments=utils.get_pydantic_model(
                    contractor_payments,
                    List[
                        models.PostV1CompaniesCompanyIDContractorPaymentGroupsPreviewContractorPayments
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1ContractorPaymentGroupsContractorPaymentGroupIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1ContractorPaymentGroupsContractorPaymentGroupIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def fund(
        ...
        *,
        ...
        ] = models.PutV1ContractorPaymentGroupsContractorPaymentGroupIDFundHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_v1_contractor_payment_groups_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.GetV1ContractorPaymentGroupsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def patch_v1_contractor_payment_groups_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.PatchV1ContractorPaymentGroupsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PatchV1ContractorPaymentGroupsIDPartnerDisbursementsRequest(
            id=id,
            x_gusto_api_version=x_gusto_api_version,
            body=models.PatchV1ContractorPaymentGroupsIDPartnerDisbursementsRequestBody(
