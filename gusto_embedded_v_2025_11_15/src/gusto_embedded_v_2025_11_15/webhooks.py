...
class Webhooks(BaseSDK):
    def list_subscriptions(
        ...
        *,
        ...
        ] = models.GetV1WebhookSubscriptionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.WebhookSubscription], http_res)
    ...
    def create_subscription(
        ...
        *,
        ...
        ] = models.PostV1WebhookSubscriptionHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        :param security:
        :param url: The URL where webhook events will be POSTed.
        :param subscription_types: The types of events to subscribe to.
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        request = models.PostV1WebhookSubscriptionRequest(
            x_gusto_api_version=x_gusto_api_version,
            body=models.PostV1WebhookSubscriptionRequestBody(
                url=url,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.WebhookSubscription, http_res)
    ...
    def get_subscription(
        ...
        *,
        ...
        ] = models.GetV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update_subscription(
        ...
        *,
        ...
        ] = models.PutV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PutV1WebhookSubscriptionUUIDRequest(
            webhook_subscription_uuid=webhook_subscription_uuid,
            x_gusto_api_version=x_gusto_api_version,
            body=models.PutV1WebhookSubscriptionUUIDRequestBody(
                subscription_types=subscription_types,
            ),
        )
    ...
    def delete_subscription(
        ...
        *,
        ...
        webhook_subscription_uuid: str,
        x_gusto_api_version: Optional[
            models.DeleteV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion
        ] = models.DeleteV1WebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def verify(
        ...
        *,
        ...
        ] = models.PutV1VerifyWebhookSubscriptionUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.WebhookSubscription:
        r"""Verify a webhook subscription
        ...
        :param security:
        :param webhook_subscription_uuid: The webhook subscription UUID.
        :param verification_token: The verification token received at the webhook subscription URL.
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        request = models.PutV1VerifyWebhookSubscriptionUUIDRequest(
            webhook_subscription_uuid=webhook_subscription_uuid,
            x_gusto_api_version=x_gusto_api_version,
            body=models.PutV1VerifyWebhookSubscriptionUUIDRequestBody(
    ...
    def request_verification_token(
        ...
        *,
        ...
        ] = models.GetV1WebhookSubscriptionVerificationTokenUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_v1_webhooks_health_check(
        self,
        *,
        security: Union[
            models.GetV1WebhooksHealthCheckSecurity,
            models.GetV1WebhooksHealthCheckSecurityTypedDict,
        ],
        x_gusto_api_version: Optional[
            models.GetV1WebhooksHealthCheckHeaderXGustoAPIVersion
        ] = models.GetV1WebhooksHealthCheckHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.WebhooksHealthCheckStatus:
        r"""Get the webhooks health status
        ...
        request = models.GetV1WebhooksHealthCheckRequest(
            x_gusto_api_version=x_gusto_api_version,
        )
        ...
        req = self._build_request(
            ...
            http_headers=http_headers,
            security=utils.get_pydantic_model(
                security, models.GetV1WebhooksHealthCheckSecurity
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.WebhooksHealthCheckStatus, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def get_v1_webhooks_health_check_async(
        self,
        *,
        security: Union[
            models.GetV1WebhooksHealthCheckSecurity,
