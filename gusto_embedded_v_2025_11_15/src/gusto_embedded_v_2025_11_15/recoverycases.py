...
class RecoveryCases(BaseSDK):
    def get(
        ...
        *,
        ...
        x_gusto_api_version: Optional[
            models.GetRecoveryCasesHeaderXGustoAPIVersion
        ] = models.GetRecoveryCasesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.RecoveryCase], http_res)
    ...
    def redebit(
        ...
        *,
        ...
        x_gusto_api_version: Optional[
            models.RedebitRecoveryCaseHeaderXGustoAPIVersion
        ] = models.RedebitRecoveryCaseHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
