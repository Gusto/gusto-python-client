...
with Gusto(
    ...
    res = gusto.reimbursements.get_v1_employees_employee_id_recurring_reimbursements(employee_id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1EmployeesEmployeeIDRecurringReimbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.reimbursements.post_v1_employees_employee_id_recurring_reimbursements(employee_id="<id>", description="as procrastinate produce provided gracefully huzzah likewise when", amount=2610.77, x_gusto_api_version=gusto_embedded_v_2025_11_15.PostV1EmployeesEmployeeIDRecurringReimbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| models.NotFoundErrorObjectError | 404, 422                        | application/json                |
| models.APIError                 | 4XX, 5XX                        | \*/\*                           |
...
with Gusto(
    ...
    res = gusto.reimbursements.get_v1_recurring_reimbursements(id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1RecurringReimbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.reimbursements.put_v1_recurring_reimbursements(id="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_embedded_v_2025_11_15.PutV1RecurringReimbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| Error Type                      | Status Code                     | Content Type                    |
| ------------------------------- | ------------------------------- | ------------------------------- |
| models.NotFoundErrorObjectError | 404, 409, 422                   | application/json                |
| models.APIError                 | 4XX, 5XX                        | \*/\*                           |
...
with Gusto(
    ...
    gusto.reimbursements.delete_v1_recurring_reimbursements(id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.DeleteV1RecurringReimbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
