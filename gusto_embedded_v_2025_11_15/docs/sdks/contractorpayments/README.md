...
with Gusto(
    ...
    res = gusto.contractor_payments.get_receipt(contractor_payment_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1ContractorPaymentsContractorPaymentUUIDReceiptHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.fund(contractor_payment_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1ContractorPaymentsContractorPaymentUUIDFundHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.list(company_id="<id>", start_date="2020-01-01", end_date="2020-12-31", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.create(company_id="<id>", contractor_uuid="<id>", date_=date.fromisoformat("2020-01-01"), x_gusto_api_version=gusto_embedded_v_2025_11_15.PostV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15, payment_method=gusto_embedded_v_2025_11_15.ContractorPaymentBodyPaymentMethod.DIRECT_DEPOSIT, wage="5000", hours="40", bonus="500", reimbursement="20")
...
with Gusto(
    ...
    res = gusto.contractor_payments.get(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    gusto.contractor_payments.delete(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.DeleteV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_payments.preview(company_uuid="<id>", contractor_payments=[], x_gusto_api_version=gusto_embedded_v_2025_11_15.GetCompaniesCompanyUUIDContractorPaymentsPreviewHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    gusto.contractor_payments.get_v1_contractor_payments_contractor_payment_id_pdf(contractor_payment_id="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetV1ContractorPaymentsContractorPaymentIDPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
