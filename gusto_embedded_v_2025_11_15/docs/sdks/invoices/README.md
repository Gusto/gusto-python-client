...
<!-- UsageSnippet language="python" operationID="get-invoices-invoice-period" method="get" path="/v1/invoices/{invoice_period}" -->
```python
...
with Gusto() as gusto:
    ...
    res = gusto.invoices.get(security=gusto_embedded_v_2025_11_15.GetInvoicesInvoicePeriodSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), invoice_period="<value>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetInvoicesInvoicePeriodHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
| `invoice_period`                                                                                                                                                                                                                       | *str*                                                                                                                                                                                                                                  | :heavy_check_mark:                                                                                                                                                                                                                     | The month we are calculating the invoice for. Must be in YYYY-MM format                                                                                                                                                                |
| `x_gusto_api_version`                                                                                                                                                                                                                  | [Optional[models.GetInvoicesInvoicePeriodHeaderXGustoAPIVersion]](../../models/getinvoicesinvoiceperiodheaderxgustoapiversion.md)                                                                                                      | :heavy_minus_sign:                                                                                                                                                                                                                     | Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.           |
