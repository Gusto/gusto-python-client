...
with Gusto(
    ...
    res = gusto.wire_in_requests.get(wire_in_request_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetWireInRequestsWireInRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
...
with Gusto(
    ...
    res = gusto.wire_in_requests.list(company_uuid="<id>", x_gusto_api_version=gusto_embedded_v_2025_11_15.GetCompaniesCompanyUUIDWireInRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
