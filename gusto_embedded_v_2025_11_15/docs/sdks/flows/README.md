...
with Gusto(
    ...
    res = gusto.flows.create(company_uuid="<id>", flow_type="company_onboarding", x_gusto_api_version=gusto_embedded_v_2025_11_15.PostV1CompanyFlowsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_11_MINUS_15)
