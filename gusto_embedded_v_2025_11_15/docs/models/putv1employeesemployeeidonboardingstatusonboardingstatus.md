...
```python
from gusto_embedded_v_2025_11_15.models import PutV1EmployeesEmployeeIDOnboardingStatusOnboardingStatus

value = PutV1EmployeesEmployeeIDOnboardingStatusOnboardingStatus.ADMIN_ONBOARDING_INCOMPLETE
```
