...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [gusto_app_integration_v_2026_06_15](#gustoappintegrationv20260615)
...
[`GustoAppIntegrationError`](./src/gusto_app_integration_v_2026_06_15/models/gustoappintegrationerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`GustoAppIntegrationError`](./src/gusto_app_integration_v_2026_06_15/models/gustoappintegrationerror.py): The base class for HTTP error responses.
  * [`NotFoundErrorObject`](./src/gusto_app_integration_v_2026_06_15/models/notfounderrorobject.py): Not Found     The requested resource does not exist. Make sure the provided ID/UUID is valid. *
