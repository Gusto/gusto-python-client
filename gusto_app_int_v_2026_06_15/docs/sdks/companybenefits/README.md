...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.list_supported(x_gusto_api_version=gusto_app_integration_v_2026_06_15.HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get(benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1BenefitsBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get_requirements(benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1BenefitsBenefitsIDRequirementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.list(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompaniesCompanyIDCompanyBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.create(company_id="<id>", description="hm pfft surge beyond", x_gusto_api_version=gusto_app_integration_v_2026_06_15.PostV1CompaniesCompanyIDCompanyBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, active=True)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get_by_id(company_benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompanyBenefitsCompanyBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
| `include`                                                                                                                                                                                                                    | [Optional[models.Include]](../../models/include.md)                                                                                                                                                                          | :heavy_minus_sign:                                                                                                                                                                                                           | Available options:<br/>- all_benefits: If with_employee_benefits=true, include all effective dated benefits for each employee instead of only the current benefits.                                                          |
| `retries`                                                                                                                                                                                                                    | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                                                                                                                             | :heavy_minus_sign:                                                                                                                                                                                                           | Configuration to override the default retry behavior of the client.                                                                                                                                                          |
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.update(company_benefit_id="<id>", version="<value>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1CompanyBenefitsCompanyBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    gusto_app_integration.company_benefits.delete(company_benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.DeleteV1CompanyBenefitsCompanyBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get_employee_benefits(company_benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompanyBenefitsCompanyBenefitIDEmployeeBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.bulk_update_employee_benefits(company_benefit_id="<id>", employee_benefits=[
        gusto_app_integration_v_2026_06_15.EmployeeBenefitForCompanyBenefit(
            employee_uuid="<id>",
        ),
    ], x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1CompanyBenefitsCompanyBenefitIDEmployeeBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get_summary(company_benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1BenefitsCompanyBenefitIDSummaryHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, start_date="2022-01-01", end_date="2022-12-31")
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.get_v1_company_benefits_company_benefit_id_contribution_exclusions(company_benefit_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompanyBenefitsCompanyBenefitIDContributionExclusionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_benefits.put_v1_company_benefits_company_benefit_id_contribution_exclusions(company_benefit_id="<id>", contribution_exclusions=[
        {
            "contribution_uuid": "082dfd3e-5b55-11f0-bb42-ab7136ba04e2",
            "contribution_type": "Bonus",
            "excluded": True,
        },
    ], x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1CompanyBenefitsCompanyBenefitIDContributionExclusionsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
