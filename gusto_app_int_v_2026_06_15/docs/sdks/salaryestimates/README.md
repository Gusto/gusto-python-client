...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.salary_estimates.get_v1_salary_estimates_id(uuid="3c9d1f7e-adda-44fb-ba0e-7e5843661514", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.salary_estimates.put_v1_salary_estimates_id(uuid="969f5dac-57dd-4091-b195-2546171d3a76", zip_code="94107", occupations=[
        {
            "code": "151252",
            "experience_level": gusto_app_integration_v_2026_06_15.PutV1SalaryEstimatesIDExperienceLevel.EXPERT,
            "time_percentage": "0.6",
            "primary": True,
        },
    ], x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, annual_net_revenue=600000.0)
...
with GustoAppIntegration() as gusto_app_integration:
    ...
    res = gusto_app_integration.salary_estimates.get_v1_salary_estimates_occupations(security=gusto_app_integration_v_2026_06_15.GetV1SalaryEstimatesOccupationsSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), search="software", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1SalaryEstimatesOccupationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
