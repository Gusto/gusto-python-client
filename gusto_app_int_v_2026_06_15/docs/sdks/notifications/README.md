...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.notifications.get_company_notifications(company_uuid="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetCompanyNotificationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
