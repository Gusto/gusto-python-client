...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.companies.get(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.companies.update(company_id="<id>", contractor_only=True, x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1CompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.companies.get_custom_fields(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompaniesCompanyIDCustomFieldsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
