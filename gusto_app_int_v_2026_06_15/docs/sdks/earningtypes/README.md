...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.earning_types.get(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.earning_types.create(company_id="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.PostV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15, name="Gym Membership")
...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.earning_types.update(company_id="<id>", earning_type_uuid="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.PutV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    gusto_app_integration.earning_types.deactivate(company_id="<id>", earning_type_uuid="<id>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.DeleteV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
