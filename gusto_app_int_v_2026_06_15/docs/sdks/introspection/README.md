...
with GustoAppIntegration() as gusto_app_integration:
    ...
    gusto_app_integration.introspection.revoke(client_id="<id>", client_secret="<value>", token="<value>", x_gusto_api_version=gusto_app_integration_v_2026_06_15.VersionHeader.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
