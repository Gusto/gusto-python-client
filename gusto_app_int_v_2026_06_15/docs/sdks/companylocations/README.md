...
with GustoAppIntegration(
    ...
    res = gusto_app_integration.company_locations.list(company_id="7b1d0df1-6403-4a06-8768-c1dd7d24d27a", x_gusto_api_version=gusto_app_integration_v_2026_06_15.GetV1CompaniesCompanyIDLocationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15)
