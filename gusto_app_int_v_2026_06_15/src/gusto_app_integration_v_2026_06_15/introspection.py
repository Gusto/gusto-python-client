...
class Introspection(BaseSDK):
    def disconnect_app_integration(
        ...
        *,
        ...
        ] = models.PostV1DisconnectAppIntegrationHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
    ...
    def oauth_access_token(
        ...
        *,
        ...
        ] = models.OauthAccessTokenHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_token_info(
        ...
        *,
        x_gusto_api_version: Optional[
            models.GetV1TokenInfoHeaderXGustoAPIVersion
        ] = models.GetV1TokenInfoHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
