...
class ShowEmployeesOnboardingStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ShowEmployeesPaymentMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ShowEmployeesCurrentEmploymentStatus(str, Enum, metaclass=utils.OpenEnumMeta):
    FULL_TIME = "full_time"
...
class ShowEmployeesStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ShowEmployeesMemberPortalInvitationStatus(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ShowEmployeesStatus(value)
            except ValueError:
                return value
        return value
...
class ShowEmployeesTypedDict(TypedDict):
    ...
    all_home_addresses: NotRequired[List[EmployeeHomeAddressHistoryEntryTypedDict]]
...
class ShowEmployees(BaseModel):
    ...
    all_home_addresses: Optional[List[EmployeeHomeAddressHistoryEntry]] = None
    ...
    @field_serializer("onboarding_status")
    def serialize_onboarding_status(self, value):
        if isinstance(value, str):
            try:
                return models.ShowEmployeesOnboardingStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_payment_method(self, value):
        if isinstance(value, str):
            try:
                return models.ShowEmployeesPaymentMethod(value)
            except ValueError:
                return value
        return value

    @field_serializer("current_employment_status")
    def serialize_current_employment_status(self, value):
        if isinstance(value, str):
            try:
                return models.ShowEmployeesCurrentEmploymentStatus(value)
            except ValueError:
                return value
        return value
