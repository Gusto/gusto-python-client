...
class BreakdownsTypedDict(TypedDict):
...
class FixedCompensationsTypedDict(TypedDict):
    ...
    breakdowns: NotRequired[List[BreakdownsTypedDict]]
...
class FixedCompensations(BaseModel):
    ...
    breakdowns: Optional[List[Breakdowns]] = None
    r"""Per-workweek amounts for this compensation, one entry per workweek
    overlapping the pay period.
...
class PayrollEmployeeCompensationsTypeBreakdownsTypedDict(TypedDict):
    start_date: NotRequired[date]
    r"""The start date of the workweek."""
    end_date: NotRequired[date]
    r"""The end date of the workweek."""
...
class PayrollEmployeeCompensationsTypeBreakdowns(BaseModel):
    start_date: Optional[date] = None
    r"""The start date of the workweek."""
...
class HourlyCompensationsTypedDict(TypedDict):
    ...
    breakdowns: NotRequired[List[PayrollEmployeeCompensationsTypeBreakdownsTypedDict]]
...
class HourlyCompensations(BaseModel):
    ...
    breakdowns: Optional[List[PayrollEmployeeCompensationsTypeBreakdowns]] = None
    r"""Per-workweek hours for this compensation, one entry per workweek
    overlapping the pay period.
...
class Federal(BaseModel):
    ...
    def serialize_amount_type(self, value):
        if isinstance(value, str):
            try:
                return models.PayrollEmployeeCompensationsTypeAmountType(value)
            except ValueError:
                return value
        return value
...
class State(BaseModel):
    ...
    def serialize_amount_type(self, value):
        if isinstance(value, str):
            try:
                return (
                    models.PayrollEmployeeCompensationsTypeCustomWithholdingsAmountType(
                        value
                    )
                )
            except ValueError:
