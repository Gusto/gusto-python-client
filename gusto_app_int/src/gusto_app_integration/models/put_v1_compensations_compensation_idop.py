...
class PutV1CompensationsCompensationIDRequestTypedDict(TypedDict):
    ...
    compensations_update_request_body: CompensationsUpdateRequestBodyTypedDict
...
class PutV1CompensationsCompensationIDRequest(BaseModel):
    ...
    compensations_update_request_body: Annotated[
        CompensationsUpdateRequestBody,
    ...
    ] = PutV1CompensationsCompensationIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
