...
class PutV1EmployeesEmployeeIDRehireRequestTypedDict(TypedDict):
    ...
    rehire_update_request_body: RehireUpdateRequestBodyTypedDict
...
class PutV1EmployeesEmployeeIDRehireRequest(BaseModel):
    ...
    rehire_update_request_body: Annotated[
        RehireUpdateRequestBody,
    ...
    ] = PutV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
