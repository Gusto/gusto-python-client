...
class PutV1CompaniesCompanyIDPayrollsPayrollIDPrepareRequest(BaseModel):
    ...
    ] = PutV1CompaniesCompanyIDPayrollsPayrollIDPrepareHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["X-Gusto-API-Version", "page", "per", "sort_by", "RequestBody"]
        )
        serialized = handler(self)
        m = {}
