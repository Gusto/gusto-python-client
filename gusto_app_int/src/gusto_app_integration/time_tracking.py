...
class TimeTracking(BaseSDK):
    def get_companies_company_uuid_time_tracking_time_sheets(
        ...
        *,
        ...
        ] = models.GetCompaniesCompanyUUIDTimeTrackingTimeSheetsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
    ...
    def post_companies_company_uuid_time_tracking_time_sheets(
        ...
        *,
        ...
        ] = models.PostCompaniesCompanyUUIDTimeTrackingTimeSheetsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PostCompaniesCompanyUUIDTimeTrackingTimeSheetsRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            time_sheet_create_body=models.TimeSheetCreateBody(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.time_sheet_create_body,
                False,
                False,
                "json",
                models.TimeSheetCreateBody,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def get_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        ...
        ] = models.GetTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def put_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        ...
        ] = models.PutTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PutTimeTrackingTimeSheetsTimeSheetUUIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            time_sheet_uuid=time_sheet_uuid,
            time_sheet_update_body=models.TimeSheetUpdateBody(
                version=version,
                entity_uuid=entity_uuid,
                entity_type=entity_type,
                job_uuid=job_uuid,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.time_sheet_update_body,
                False,
                False,
                "json",
                models.TimeSheetUpdateBody,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def delete_time_tracking_time_sheets_time_sheet_uuid(
        ...
        *,
        ...
        ] = models.DeleteTimeTrackingTimeSheetsTimeSheetUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
