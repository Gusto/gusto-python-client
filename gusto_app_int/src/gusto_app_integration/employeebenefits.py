...
class EmployeeBenefits(BaseSDK):
    def get_all(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeIDEmployeeBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1EmployeesEmployeeIDEmployeeBenefitsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PostV1EmployeesEmployeeIDEmployeeBenefitsRequest(
            x_gusto_api_version=x_gusto_api_version,
            employee_id=employee_id,
            employee_benefit_create_request=models.EmployeeBenefitCreateRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.employee_benefit_create_request,
                False,
                False,
                "json",
                models.EmployeeBenefitCreateRequest,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1EmployeeBenefitsEmployeeBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1EmployeeBenefitsEmployeeBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PutV1EmployeeBenefitsEmployeeBenefitIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            employee_benefit_id=employee_benefit_id,
            employee_benefit_update_request=models.EmployeeBenefitUpdateRequest(
                version=version,
                active=active,
                employee_deduction=employee_deduction,
                deduct_as_percentage=deduct_as_percentage,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.employee_benefit_update_request,
                False,
                False,
                "json",
                models.EmployeeBenefitUpdateRequest,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1EmployeeBenefitsEmployeeBenefitIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def get_ytd_benefit_amounts_from_different_company(
        ...
        *,
        ...
        ] = models.GetEmployeeYtdBenefitAmountsFromDifferentCompanyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
    ...
    def create_ytd_benefit_amounts_from_different_company(
        ...
        *,
        ...
        ] = models.PostEmployeeYtdBenefitAmountsFromDifferentCompanyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest(
            x_gusto_api_version=x_gusto_api_version,
            employee_id=employee_id,
            ytd_benefit_amounts_from_different_company_body=models.YtdBenefitAmountsFromDifferentCompanyBody(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.ytd_benefit_amounts_from_different_company_body,
                False,
                False,
                "json",
    ...
    def get_v1_employees_employee_uuid_section603_high_earner_statuses(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeUUIDSection603HighEarnerStatusesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def post_v1_employees_employee_uuid_section603_high_earner_statuses(
        ...
        *,
        ...
        ] = models.PostV1EmployeesEmployeeUUIDSection603HighEarnerStatusesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.employee_section603_high_earner_status_create_request,
                False,
                False,
                "json",
    ...
    def get_v1_employees_employee_uuid_section603_high_earner_statuses_effective_year(
        ...
        *,
        ...
        ] = models.GetV1EmployeesEmployeeUUIDSection603HighEarnerStatusesEffectiveYearHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def patch_v1_employees_employee_uuid_section603_high_earner_statuses_effective_year(
        ...
        *,
        ...
        ] = models.PatchV1EmployeesEmployeeUUIDSection603HighEarnerStatusesEffectiveYearHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.employee_section603_high_earner_status_update_request,
                False,
                False,
                "json",
