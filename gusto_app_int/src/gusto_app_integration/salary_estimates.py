...
class SalaryEstimates(BaseSDK):
    def post_v1_employees_employee_id_salary_estimates(
        ...
        *,
        ...
        ] = models.PostV1EmployeesEmployeeIDSalaryEstimatesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PostV1EmployeesEmployeeIDSalaryEstimatesRequest(
            ...
            request_body=models.PostV1EmployeesEmployeeIDSalaryEstimatesRequestBody(
    ...
    def get_v1_salary_estimates_id(
        ...
        *,
        ...
        ] = models.GetV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def put_v1_salary_estimates_id(
        ...
        *,
        ...
        ] = models.PutV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        annual_net_revenue: OptionalNullable[float] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.PutV1SalaryEstimatesIDRequest(
            x_gusto_api_version=x_gusto_api_version,
            uuid=uuid,
            request_body=models.PutV1SalaryEstimatesIDRequestBody(
                annual_net_revenue=annual_net_revenue,
                zip_code=zip_code,
                occupations=utils.get_pydantic_model(
    ...
    def post_v1_salary_estimates_uuid_accept(
        ...
        *,
        ...
        ] = models.PostV1SalaryEstimatesUUIDAcceptHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PostV1SalaryEstimatesUUIDAcceptRequest(
            x_gusto_api_version=x_gusto_api_version,
            uuid=uuid,
            request_body=models.PostV1SalaryEstimatesUUIDAcceptRequestBody(
    ...
    def get_v1_salary_estimates_occupations(
        ...
        *,
        ...
        ] = models.GetV1SalaryEstimatesOccupationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
