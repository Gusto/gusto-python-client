...
```python
from gusto_app_integration.models import PutV1CompanyBenefitsCompanyBenefitIDCatchUpType

value = PutV1CompanyBenefitsCompanyBenefitIDCatchUpType.ELECTIVE
```
