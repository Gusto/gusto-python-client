...
with GustoAppIntegration(
    ...
    res = gai_client.departments.get(department_uuid="<id>", x_gusto_api_version=gusto_app_integration.GetDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.departments.update(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", title="Stage Hand", x_gusto_api_version=gusto_app_integration.PutDepartmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    gai_client.departments.delete(department_uuid="<id>", x_gusto_api_version=gusto_app_integration.DeleteDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.departments.add_people(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_app_integration.PutAddPeopleToDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.departments.remove_people(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_app_integration.PutRemovePeopleFromDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
