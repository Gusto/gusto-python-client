...
with GustoAppIntegration(
    ...
    res = gai_client.salary_estimates.post_v1_employees_employee_id_salary_estimates(employee_id="<id>", zip_code="94107", occupations=[], x_gusto_api_version=gusto_app_integration.PostV1EmployeesEmployeeIDSalaryEstimatesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01, annual_net_revenue=500000)
...
with GustoAppIntegration(
    ...
    res = gai_client.salary_estimates.get_v1_salary_estimates_id(uuid="3c9d1f7e-adda-44fb-ba0e-7e5843661514", x_gusto_api_version=gusto_app_integration.GetV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
...
with GustoAppIntegration(
    ...
    res = gai_client.salary_estimates.put_v1_salary_estimates_id(uuid="969f5dac-57dd-4091-b195-2546171d3a76", zip_code="94107", occupations=[
        {
            "code": "151252",
            "experience_level": gusto_app_integration.PutV1SalaryEstimatesIDExperienceLevel.EXPERT,
            "time_percentage": "0.6",
            "primary": True,
        },
    ], x_gusto_api_version=gusto_app_integration.PutV1SalaryEstimatesIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01, annual_net_revenue=600000)
...
with GustoAppIntegration(
    ...
    res = gai_client.salary_estimates.post_v1_salary_estimates_uuid_accept(uuid="22c00075-fa4c-4bdc-91e3-f72ab8ec7a1d", employee_job_uuid="7f5d3d93-6d6f-48c0-9f4e-cd12c2d3e4b2", x_gusto_api_version=gusto_app_integration.PostV1SalaryEstimatesUUIDAcceptHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.salary_estimates.get_v1_salary_estimates_occupations(security=gusto_app_integration.GetV1SalaryEstimatesOccupationsSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), search="software", x_gusto_api_version=gusto_app_integration.GetV1SalaryEstimatesOccupationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
