...
with GustoAppIntegration(
    ...
    res = gai_client.contractor_payments.get(company_id="<id>", start_date="2020-01-01", end_date="2020-12-31", x_gusto_api_version=gusto_app_integration.GetV1CompaniesCompanyIDContractorPaymentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.contractor_payments.get_by_id(company_id="<id>", contractor_payment_id="<id>", x_gusto_api_version=gusto_app_integration.GetV1CompaniesCompanyIDContractorPaymentContractorPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
