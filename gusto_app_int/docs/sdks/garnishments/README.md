...
with GustoAppIntegration(
    ...
    res = gai_client.garnishments.create(employee_id="<id>", amount="<value>", court_ordered=False, x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, active=True, times=None, recurring=False, annual_maximum=None, pay_period_maximum=None, deduct_as_percentage=False)
...
with GustoAppIntegration(
    ...
    res = gai_client.garnishments.create(employee_id="<id>", amount="40", court_ordered=True, x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, active=True, garnishment_type=gusto_app_integration.PostV1EmployeesEmployeeIDGarnishmentsGarnishmentType.CHILD_SUPPORT, times=None, recurring=True, annual_maximum=None, pay_period_maximum="500.00", deduct_as_percentage=True, child_support={
        "state": "FL",
        "payment_period": gusto_app_integration.PaymentPeriod.MONTHLY,
        "fips_code": "12011",
        "case_number": "CS1234",
    })
...
with GustoAppIntegration(
    ...
    res = gai_client.garnishments.update(garnishment_id="<id>", version="<value>", x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, active=True, times=None, recurring=False, annual_maximum=None, pay_period_maximum=None, deduct_as_percentage=False)
