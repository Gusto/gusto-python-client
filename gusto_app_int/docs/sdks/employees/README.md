...
with GustoAppIntegration(
    ...
    res = gai_client.employees.create(company_id="<id>", first_name="Linda", last_name="Kautzer", x_gusto_api_version=gusto_app_integration.PostV1EmployeesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
...
with GustoAppIntegration(
    ...
    res = gai_client.employees.update(employee_id="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_app_integration.PutV1EmployeesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01, first_name="Weezy", middle_initial="F", last_name="Baby", email="tunechi@cashmoneyrecords.com", date_of_birth="1991-01-31", ssn="824920233", work_email="new.partner.work@example.com")
