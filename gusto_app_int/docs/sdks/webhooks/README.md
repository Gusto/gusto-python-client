...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.webhooks.create(security=gusto_app_integration.PostV1WebhookSubscriptionSecurity(
        ...
        gusto_app_integration.PostV1WebhookSubscriptionSubscriptionTypes.LOCATION,
...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.webhooks.update_subscription(security=gusto_app_integration.PutV1WebhookSubscriptionUUIDSecurity(
        ...
        gusto_app_integration.PutV1WebhookSubscriptionUUIDSubscriptionTypes.PAYROLL,
    ], x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.webhooks.get_subscription(security=gusto_app_integration.GetV1WebhookSubscriptionUUIDSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), webhook_subscription_uuid="<id>", x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.webhooks.verify(security=gusto_app_integration.PutV1VerifyWebhookSubscriptionUUIDSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), webhook_subscription_uuid="<id>", verification_token="<value>", x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration() as gai_client:
    ...
    res = gai_client.webhooks.verify(security=gusto_app_integration.PutV1VerifyWebhookSubscriptionUUIDSecurity(
        system_access_auth="<YOUR_BEARER_TOKEN_HERE>",
    ), webhook_subscription_uuid="<id>", verification_token="asefasedfe23e234easd", x_gusto_api_version=gusto_app_integration.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
