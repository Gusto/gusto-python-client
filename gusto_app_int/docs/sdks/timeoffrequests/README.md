...
with GustoAppIntegration(
    ...
    res = gai_client.time_off_requests.get_v1_companies_company_id_time_off_requests(company_id="<id>", x_gusto_api_version=gusto_app_integration.GetV1CompaniesCompanyIDTimeOffRequestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
