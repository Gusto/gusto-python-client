...
with GustoAppIntegration(
    ...
    res = gai_client.company_locations.list(company_id="7b1d0df1-6403-4a06-8768-c1dd7d24d27a", x_gusto_api_version=gusto_app_integration.GetV1CompaniesCompanyIDLocationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
