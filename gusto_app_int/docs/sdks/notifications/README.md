...
with GustoAppIntegration(
    ...
    res = gai_client.notifications.get_company_notifications(company_uuid="<id>", x_gusto_api_version=gusto_app_integration.GetCompanyNotificationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
