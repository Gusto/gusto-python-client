...
with GustoAppIntegration(
    ...
    res = gai_client.reports.post_payrolls_payroll_uuid_reports_general_ledger(payroll_uuid="<id>", aggregation=gusto_app_integration.Aggregation.DEFAULT, x_gusto_api_version=gusto_app_integration.PostPayrollsPayrollUUIDReportsGeneralLedgerHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.reports.get_reports_request_uuid(request_uuid="<id>", x_gusto_api_version=gusto_app_integration.GetReportsRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
