...
with GustoAppIntegration(
    ...
    res = gai_client.employee_employments.get_rehire(employee_id="<id>", x_gusto_api_version=gusto_app_integration.GetV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.employee_employments.create_rehire(employee_id="<id>", effective_date="2023-06-30", file_new_hire_report=False, work_location_uuid="b6ae9d93-d4b8-4119-8c96-dba595dd8c30", x_gusto_api_version=gusto_app_integration.PostV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    gai_client.employee_employments.delete_rehire(employee_id="<id>", x_gusto_api_version=gusto_app_integration.DeleteV1EmployeesEmployeeIDRehireHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.employee_employments.get_v1_terminations_employee_id(employee_id="<id>", x_gusto_api_version=gusto_app_integration.GetV1TerminationsEmployeeIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
