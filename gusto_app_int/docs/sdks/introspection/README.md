...
with GustoAppIntegration() as gai_client:
    ...
    gai_client.introspection.revoke(client_id="<id>", client_secret="<value>", token="<value>", x_gusto_api_version=gusto_app_integration.HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
