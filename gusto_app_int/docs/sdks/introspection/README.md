...
with GustoAppIntegration() as gai_client:
    ...
    gai_client.introspection.revoke(client_id="<id>", client_secret="<value>", token="<value>", x_gusto_api_version=gusto_app_integration.RevokeAccessTokenHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration() as gai_client:
    ...
    }, x_gusto_api_version=gusto_app_integration.OauthAccessTokenHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with GustoAppIntegration(
    ...
    res = gai_client.introspection.get_token_info(x_gusto_api_version=gusto_app_integration.GetV1TokenInfoHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
