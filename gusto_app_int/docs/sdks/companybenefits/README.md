...
with GustoAppIntegration(
    ...
    res = gai_client.company_benefits.list_supported(x_gusto_api_version=gusto_app_integration.HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
