...
with Gusto(
    ...
    res = gusto.industry_selection.get(company_id="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.industry_selection.update(company_id="<id>", naics_code="611420", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, title="Computer Training", sic_codes=[
        "8243",
    ])
