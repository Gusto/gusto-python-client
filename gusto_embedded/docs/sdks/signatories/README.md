...
with Gusto(
    ...
    res = gusto.signatories.create(company_uuid="<id>", first_name="Ed", last_name="Reichert", title="<value>", phone="914.468.8146 x29683", birthday=date.fromisoformat("2026-11-04"), email="Mariah_Huel64@gmail.com", ssn="<value>", home_address={
        ...
        "state": "Rhode Island",
        "zip": "37195",
    }, x_gusto_api_version=gusto_embedded.PostV1CompanySignatoriesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.signatories.list(company_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1CompaniesCompanyUUIDSignatoriesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.signatories.invite(company_uuid="<id>", first_name="Madelyn", last_name="Littel", email="Harmon_Heidenreich@yahoo.com", x_gusto_api_version=gusto_embedded.PostV1CompaniesCompanyUUIDSignatoriesInviteHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.signatories.update(company_uuid="<id>", signatory_uuid="<id>", version="<value>", x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyUUIDSignatoriesSignatoryUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.signatories.delete(company_uuid="<id>", signatory_uuid="<id>", x_gusto_api_version=gusto_embedded.DeleteV1CompaniesCompanyUUIDSignatoriesSignatoryUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
