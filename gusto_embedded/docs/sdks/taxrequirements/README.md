...
with Gusto(
    ...
    res = gusto.tax_requirements.get(company_uuid="<id>", state="CA", x_gusto_api_version=gusto_embedded.GetV1CompaniesCompanyUUIDTaxRequirementsStateHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.tax_requirements.update_state(company_uuid="<id>", state="CA", x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyUUIDTaxRequirementsStateHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, requirement_sets=[
        {
            "key": "registrations",
            "state": "GA",
...
with Gusto(
    ...
    res = gusto.tax_requirements.get_all(company_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1CompaniesCompanyUUIDTaxRequirementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
