...
with Gusto(
    ...
    res = gusto.departments.get_all(company_uuid="<id>", x_gusto_api_version=gusto_embedded.GetCompaniesDepartmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.departments.create(company_uuid="<id>", title="Stage Hand", x_gusto_api_version=gusto_embedded.PostDepartmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.departments.get(department_uuid="<id>", x_gusto_api_version=gusto_embedded.GetDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.departments.update(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", title="Stage Hand", x_gusto_api_version=gusto_embedded.PutDepartmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.departments.delete(department_uuid="<id>", x_gusto_api_version=gusto_embedded.DeleteDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.departments.add_people(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_embedded.PutAddPeopleToDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.departments.remove_people(department_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_embedded.PutRemovePeopleFromDepartmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
