...
with Gusto(
    ...
    res = gusto.employee_payment_methods.get_bank_accounts(employee_id="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
