...
<!-- UsageSnippet language="python" operationID="get-v1-employees-employee_id-bank_accounts" method="get" path="/v1/employees/{employee_id}/bank_accounts" example="Example" -->
```python
...
with Gusto(
    ...
    res = gusto.employee_payment_methods.get_bank_accounts(employee_id="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
