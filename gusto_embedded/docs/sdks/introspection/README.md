...
with Gusto(
    ...
    res = gusto.introspection.refresh_token(client_id="<id>", client_secret="<value>", refresh_token="<value>", grant_type="<value>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
