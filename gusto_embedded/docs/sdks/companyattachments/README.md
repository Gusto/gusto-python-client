...
* [get_all](#get_all) - Get List of Company Attachments
...
with Gusto(
    ...
    res = g_client.company_attachments.get_details(company_id="<id>", company_attachment_uuid="<id>")
...
with Gusto(
    ...
    res = g_client.company_attachments.get_all(company_id="<id>")
