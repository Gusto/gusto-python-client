...
with Gusto(
    ...
    res = gusto.employee_addresses.get(employee_id="<id>")
...
with Gusto(
    ...
    res = gusto.employee_addresses.retrieve_home_address(home_address_uuid="<id>")
...
with Gusto(
    ...
    gusto.employee_addresses.delete(home_address_uuid="<id>")
...
with Gusto(
    ...
    res = gusto.employee_addresses.get_work_addresses(employee_id="<id>")
...
with Gusto(
    ...
    res = gusto.employee_addresses.create_work_address(employee_id="<id>", location_uuid="f3ce2f31-cba6-4f18-b66b-291de5d52ca2", effective_date=date.fromisoformat("2020-01-31"))
...
with Gusto(
    ...
    res = gusto.employee_addresses.retrieve_work_address(work_address_uuid="<id>")
...
with Gusto(
    ...
    res = gusto.employee_addresses.update_work_address(work_address_uuid="<id>", version="cd2e396aff8925367ff773e771e40488", location_uuid="333eb008-db81-4003-9e91-1ad257226518", effective_date=date.fromisoformat("2023-05-15"))
...
with Gusto(
    ...
    gusto.employee_addresses.delete_work_address(work_address_uuid="<id>")
