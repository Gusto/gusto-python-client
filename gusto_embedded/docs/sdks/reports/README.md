...
with Gusto() as gusto:
    ...
    res = gusto.reports.post_v1_bulk_reports(security=gusto_embedded.PostV1BulkReportsSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), batch=[
        {
            "company_uuid": "12345678-abcd-ef12-3456-7890abcdef12",
            "report_type": gusto_embedded.ReportType.CUSTOM_REPORT,
            "columns": [
                gusto_embedded.Columns.EMPLOYEE_FIRST_NAME,
            ],
            "groupings": [
                gusto_embedded.Groupings.EMPLOYEE,
            ],
            "file_type": gusto_embedded.FileType.CSV,
            "custom_name": "Q1 Payroll Export",
            "with_totals": False,
            "date_filter_type": gusto_embedded.DateFilterType.CHECK_DATE,
            "start_date": date.fromisoformat("2026-01-01"),
            "end_date": date.fromisoformat("2026-03-31"),
            "payment_method": gusto_embedded.PaymentMethod.CHECK,
            "employment_type": gusto_embedded.EmploymentType.EXEMPT,
            "employment_status": gusto_embedded.EmploymentStatus.ACTIVE_FULL_TIME,
        },
        {
            "company_uuid": "12345678-abcd-ef12-3456-7890abcdef12",
            "report_type": gusto_embedded.BulkReportGeneralLedgerItemReportType.GENERAL_LEDGER,
            "payroll_uuid": "7b1d0df1-6403-4a06-8768-c1dd7d24d27a",
            "aggregation": gusto_embedded.Aggregation.DEFAULT,
        },
    ], x_gusto_api_version=gusto_embedded.PostV1BulkReportsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.reports.get_v1_bulk_reports_request_uuid(security=gusto_embedded.GetV1BulkReportsRequestUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), request_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1BulkReportsRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.reports.create_custom(company_uuid="<id>", columns=[
        gusto_embedded.CreateReportBodyColumns.TOTAL_TIME_OFF_EARNINGS,
    ], file_type=gusto_embedded.CreateReportBodyFileType.JSON, x_gusto_api_version=gusto_embedded.PostCompaniesCompanyUUIDReportsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, with_totals=False, date_filter_type=gusto_embedded.CreateReportBodyDateFilterType.PERIOD_END_DATE, start_date=date.fromisoformat("2024-01-01"), end_date=date.fromisoformat("2024-04-01"), dismissed_start_date=date.fromisoformat("2024-01-01"), dismissed_end_date=date.fromisoformat("2024-04-01"))
...
with Gusto(
    ...
    res = gusto.reports.post_payrolls_payroll_uuid_reports_general_ledger(payroll_uuid="<id>", aggregation=gusto_embedded.GeneralLedgerReportBodyAggregation.DEFAULT, x_gusto_api_version=gusto_embedded.PostPayrollsPayrollUUIDReportsGeneralLedgerHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
