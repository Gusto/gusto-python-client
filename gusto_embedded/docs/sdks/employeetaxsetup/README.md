...
with Gusto(
    ...
    res = gusto.employee_tax_setup.update_federal_taxes(employee_uuid="<id>", version="56a489ce86ed6c1b0f0cecc4050a0b01", filing_status=gusto_embedded.FilingStatus.SINGLE, w4_data_type=gusto_embedded.PutV1EmployeesEmployeeIDFederalTaxesW4DataType.REV_2020_W4, x_gusto_api_version=gusto_embedded.PutV1EmployeesEmployeeIDFederalTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
