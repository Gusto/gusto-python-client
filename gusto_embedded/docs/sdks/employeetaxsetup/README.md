...
with Gusto(
    ...
    res = gusto.employee_tax_setup.get_state_taxes(employee_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1EmployeesEmployeeIDStateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
...
with Gusto(
    ...
    res = gusto.employee_tax_setup.update_state_taxes(employee_uuid="<id>", states=[], x_gusto_api_version=gusto_embedded.PutV1EmployeesEmployeeIDStateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01)
