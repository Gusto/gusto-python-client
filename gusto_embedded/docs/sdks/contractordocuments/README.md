...
with Gusto(
    ...
    res = gusto.contractor_documents.get_all(contractor_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1ContractorDocumentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_documents.get(document_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1ContractorDocumentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_documents.get_pdf(document_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1ContractorDocumentPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.contractor_documents.sign(document_uuid="<id>", fields=[], agree=False, x_gusto_api_version=gusto_embedded.PutV1ContractorDocumentSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
