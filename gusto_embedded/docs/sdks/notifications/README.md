...
with Gusto(
    ...
    res = gusto.notifications.get_details(notification_uuid="<id>", x_gusto_api_version=gusto_embedded.GetNotificationsNotificationUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
