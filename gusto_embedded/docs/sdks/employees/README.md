...
with Gusto(
    ...
    res = gusto.employees.update_onboarding_documents_config(employee_id="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, i9_document=True)
