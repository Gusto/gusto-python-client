...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.get(company_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.create(company_uuid="<id>", x_gusto_api_version=gusto_embedded.PostV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.update(company_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.holiday_pay_policies.delete(company_uuid="<id>", x_gusto_api_version=gusto_embedded.DeleteV1CompaniesCompanyUUIDHolidayPayPolicyHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.add_employees(company_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", employees=[], x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyUUIDHolidayPayPolicyAddHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.remove_employees(company_uuid="<id>", version="56d00c178bc7393b2a206ed6a86afcb4", employees=[
        {},
    ], x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyUUIDHolidayPayPolicyRemoveHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
<!-- UsageSnippet language="python" operationID="get-companies-company_uuid-paid_holidays" method="get" path="/v1/companies/{company_uuid}/paid_holidays" example="Basic" -->
```python
import gusto_embedded
from gusto_embedded import Gusto
import os
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.preview_paid_holidays(company_uuid="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
<!-- UsageSnippet language="python" operationID="get-companies-company_uuid-paid_holidays" method="get" path="/v1/companies/{company_uuid}/paid_holidays" example="Example" -->
```python
import gusto_embedded
from gusto_embedded import Gusto
import os
...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.preview_paid_holidays(company_uuid="<id>", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, year="2023")
...
<!-- UsageSnippet language="python" operationID="get-companies-company_uuid-paid_holidays" method="get" path="/v1/companies/{company_uuid}/paid_holidays" example="Nested" -->
```python
import gusto_embedded
from gusto_embedded import Gusto
import os
...
<!-- UsageSnippet language="python" operationID="get-companies-company_uuid-paid_holidays" method="get" path="/v1/companies/{company_uuid}/paid_holidays" example="Resource" -->
```python
import gusto_embedded
from gusto_embedded import Gusto
import os
...
**[models.PaidHolidays](../../models/paidholidays.md)**
