...
with Gusto(
    ...
    res = gusto.holiday_pay_policies.preview_paid_holidays(company_uuid="<id>", x_gusto_api_version=gusto_embedded.GetCompaniesCompanyUUIDPaidHolidaysHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, year="2023")
