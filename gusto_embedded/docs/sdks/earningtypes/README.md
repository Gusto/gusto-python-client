...
with Gusto(
    ...
    res = g_client.earning_types.create(company_id="<id>", name="Gym Membership Stipend")
...
with Gusto(
    ...
    res = g_client.earning_types.get_all(company_id="<id>")
...
with Gusto(
    ...
    res = g_client.earning_types.update(company_id="<id>", earning_type_uuid="<id>", name="Gym Membership Stipend")
...
with Gusto(
    ...
    g_client.earning_types.deactivate(company_id="<id>", earning_type_uuid="<id>")
