...
with Gusto(
    ...
    res = gusto.earning_types.list(company_id="<id>", x_gusto_api_version=gusto_embedded.GetV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    res = gusto.earning_types.create(company_id="<id>", x_gusto_api_version=gusto_embedded.PostV1CompaniesCompanyIDEarningTypesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15, name="Gym Membership")
...
with Gusto(
    ...
    res = gusto.earning_types.update(company_id="<id>", earning_type_uuid="<id>", x_gusto_api_version=gusto_embedded.PutV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto(
    ...
    gusto.earning_types.delete(company_id="<id>", earning_type_uuid="<id>", x_gusto_api_version=gusto_embedded.DeleteV1CompaniesCompanyIDEarningTypesEarningTypeUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
