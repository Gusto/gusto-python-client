...
with Gusto(
    ...
    res = gusto.flows.create(company_uuid="<id>", flow_type="company_retirement_benefits", x_gusto_api_version=gusto_embedded.VersionHeader.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
