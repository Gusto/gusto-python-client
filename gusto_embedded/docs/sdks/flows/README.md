...
with Gusto(
    ...
    res = gusto.flows.create(company_uuid="<id>", flow_type="company_onboarding", x_gusto_api_version=gusto_embedded.PostV1CompanyFlowsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
