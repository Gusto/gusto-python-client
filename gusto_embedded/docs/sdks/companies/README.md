...
with Gusto(
    ...
    res = g_client.companies.get(company_id="<id>")
...
with Gusto(
    ...
    res = g_client.companies.update(company_id="<id>", contractor_only=False)
...
with Gusto(
    ...
    res = g_client.companies.migrate(company_uuid="<id>", email="Benjamin_Kihn44@yahoo.com", ip_address="198.52.136.51", external_user_id="<id>")
...
with Gusto(
    ...
    res = g_client.companies.accept_terms_of_service(company_uuid="<id>", email="jsmith99@gmail.com", ip_address="192.168.1.2", external_user_id="2005648946132")
...
with Gusto(
    ...
    res = g_client.companies.retrieve_terms_of_service(company_uuid="<id>", email="jsmith99@gmail.com")
...
with Gusto(
    ...
    res = g_client.companies.create_admin(company_id="<id>", first_name="John", last_name="Smith", email="jsmith99@gmail.com")
...
with Gusto(
    ...
    res = g_client.companies.get_admins(company_id="<id>")
...
with Gusto(
    ...
    res = g_client.companies.get_onboarding_status(company_uuid="<id>")
...
with Gusto(
    ...
    res = g_client.companies.finish_onboarding(company_uuid="<id>")
...
with Gusto(
    ...
    res = g_client.companies.get_custom_fields(company_id="<id>")
