...
with Gusto(
    ...
    res = gusto.companies.list_admins(company_id="<id>", x_gusto_api_version=gusto_embedded.HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
