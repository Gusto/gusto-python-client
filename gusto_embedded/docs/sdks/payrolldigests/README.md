...
with Gusto() as gusto:
    ...
    res = gusto.payroll_digests.post_v1_payroll_digests(security=gusto_embedded.PostV1PayrollDigestsSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), idempotency_key="80a74f8b-2c16-45e5-9038-aa108849c6e6", batch_action=gusto_embedded.PostV1PayrollDigestsBatchAction.CREATE, batch=[], x_gusto_api_version=gusto_embedded.PostV1PayrollDigestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
...
with Gusto() as gusto:
    ...
    res = gusto.payroll_digests.get_v1_payroll_digests_payroll_digest_uuid(security=gusto_embedded.GetV1PayrollDigestsPayrollDigestUUIDSecurity(
        system_access_auth=os.getenv("GUSTO_SYSTEM_ACCESS_AUTH", ""),
    ), payroll_digest_uuid="<id>", x_gusto_api_version=gusto_embedded.GetV1PayrollDigestsPayrollDigestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15)
