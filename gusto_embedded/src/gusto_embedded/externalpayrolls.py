...
class ExternalPayrolls(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompanyExternalPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1ExternalPayrollHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PostV1ExternalPayrollRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            external_payroll_create_request=models.ExternalPayrollCreateRequest(
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.external_payroll_create_request,
                False,
                False,
                "json",
                models.ExternalPayrollCreateRequest,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def retrieve(
        ...
        *,
        ...
        ] = models.GetV1ExternalPayrollHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1ExternalPayrollHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        ...
        request = models.PutV1ExternalPayrollRequest(
            ...
            company_uuid=company_uuid,
            external_payroll_id=external_payroll_id,
            external_payroll_update_request=models.ExternalPayrollUpdateRequest(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.external_payroll_update_request,
                False,
                False,
                "json",
                models.ExternalPayrollUpdateRequest,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1ExternalPayrollHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def calculate_taxes(
        ...
        *,
        ...
        ] = models.GetV1ExternalPayrollCalculateTaxesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def list_tax_liabilities(
        ...
        *,
        ...
        ] = models.GetV1TaxLiabilitiesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def update_tax_liabilities(
        ...
        *,
        ...
        ] = models.PutV1TaxLiabilitiesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.PutV1TaxLiabilitiesRequest(
            x_gusto_api_version=x_gusto_api_version,
            company_uuid=company_uuid,
            tax_liability_selections_request=models.TaxLiabilitySelectionsRequest(
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.tax_liability_selections_request,
                False,
                False,
                "json",
                models.TaxLiabilitySelectionsRequest,
            ),
            allow_empty_value=None,
            allowed_fields=["company_access_auth"],
            timeout_ms=timeout_ms,
    ...
    def finalize_tax_liabilities(
        ...
        *,
        ...
        ] = models.PutV1TaxLiabilitiesFinishHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
