...
class ContractorPaymentGroups(BaseSDK):
    def post_v1_companies_company_id_contractor_payment_groups(
        self,
        *,
        company_id: str,
        check_date: date,
    ...
    async def post_v1_companies_company_id_contractor_payment_groups_async(
        self,
        *,
        company_id: str,
        check_date: date,
    ...
    def get_v1_companies_company_id_contractor_payment_groups(
        self,
        *,
        company_id: str,
    ...
    async def get_v1_companies_company_id_contractor_payment_groups_async(
        self,
        *,
        company_id: str,
        start_date: Optional[str] = None,
    ...
    def post_v1_companies_company_id_contractor_payment_groups_preview(
        self,
        *,
        company_id: str,
        check_date: date,
    ...
    async def post_v1_companies_company_id_contractor_payment_groups_preview_async(
        self,
        *,
        company_id: str,
        check_date: date,
    ...
    def get_v1_contractor_payment_groups_contractor_payment_group_id(
        self,
        *,
    ...
    async def get_v1_contractor_payment_groups_contractor_payment_group_id_async(
        self,
        *,
        contractor_payment_group_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def delete_v1_contractor_payment_groups_contractor_payment_group_id(
        self,
        *,
        contractor_payment_group_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def delete_v1_contractor_payment_groups_contractor_payment_group_id_async(
        self,
        *,
        contractor_payment_group_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def put_v1_contractor_payment_groups_contractor_payment_group_id_fund(
        self,
        *,
        contractor_payment_group_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def put_v1_contractor_payment_groups_contractor_payment_group_id_fund_async(
        self,
        *,
        contractor_payment_group_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
