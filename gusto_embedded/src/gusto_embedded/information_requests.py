...
class InformationRequests(BaseSDK):
    def get_information_requests(
        ...
        *,
        ...
        ] = models.GetInformationRequestsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15,
    ...
    def submit(
        ...
        *,
        ...
        request = models.SubmitInformationRequestRequest(
            ...
            request_body=models.SubmitInformationRequestRequestBody(
