...
class BankAccounts(BaseSDK):
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDBankAccountsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
    ...
    def create(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDBankAccountsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def delete_v1_companies_company_id_bank_accounts_bank_account_id(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyIDBankAccountsBankAccountIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
