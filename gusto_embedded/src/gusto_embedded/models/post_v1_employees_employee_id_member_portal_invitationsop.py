...
class PostV1EmployeesEmployeeIDMemberPortalInvitationsHeaderXGustoAPIVersion(str, Enum):
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""

    TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15 = "2025-06-15"


class PostV1EmployeesEmployeeIDMemberPortalInvitationsRequestTypedDict(TypedDict):
    employee_id: str
...
class PostV1EmployeesEmployeeIDMemberPortalInvitationsRequest(BaseModel):
    ...
    ] = PostV1EmployeesEmployeeIDMemberPortalInvitationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
