...
class PutV1EmployeesEmployeeIDOnboardingDocumentsConfigRequestTypedDict(TypedDict):
    ...
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
    employee_onboarding_documents_config_request: NotRequired[
        EmployeeOnboardingDocumentsConfigRequestTypedDict
    ]
...
class PutV1EmployeesEmployeeIDOnboardingDocumentsConfigRequest(BaseModel):
    ...
    ] = PutV1EmployeesEmployeeIDOnboardingDocumentsConfigHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""

    employee_onboarding_documents_config_request: Annotated[
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["X-Gusto-API-Version", "Employee-Onboarding-Documents-Config-Request"]
        )
