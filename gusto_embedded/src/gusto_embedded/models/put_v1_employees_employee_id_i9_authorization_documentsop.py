...
class PutV1EmployeesEmployeeIDI9AuthorizationDocumentsRequestTypedDict(TypedDict):
    ...
    i9_authorization_documents_request_body: (
        I9AuthorizationDocumentsRequestBodyTypedDict
    )
...
class PutV1EmployeesEmployeeIDI9AuthorizationDocumentsRequest(BaseModel):
    ...
    i9_authorization_documents_request_body: Annotated[
        I9AuthorizationDocumentsRequestBody,
    ...
    ] = PutV1EmployeesEmployeeIDI9AuthorizationDocumentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
