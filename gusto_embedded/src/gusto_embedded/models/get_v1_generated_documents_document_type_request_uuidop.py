...
class GetV1GeneratedDocumentsDocumentTypeRequestUUIDHeaderXGustoAPIVersion(str, Enum):
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""

    TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15 = "2025-06-15"


class PathParamDocumentType(str, Enum):
...
class GetV1GeneratedDocumentsDocumentTypeRequestUUIDRequestTypedDict(TypedDict):
    document_type: PathParamDocumentType
    r"""The type of document being generated"""
    request_uuid: str
...
class GetV1GeneratedDocumentsDocumentTypeRequestUUIDRequest(BaseModel):
    ...
    ] = GetV1GeneratedDocumentsDocumentTypeRequestUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
