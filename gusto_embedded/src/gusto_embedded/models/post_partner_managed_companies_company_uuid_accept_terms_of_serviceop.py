...
class PostPartnerManagedCompaniesCompanyUUIDAcceptTermsOfServiceRequestTypedDict(
    ...
    partner_managed_company_accept_terms_of_service_request: (
        PartnerManagedCompanyAcceptTermsOfServiceRequestTypedDict
    )
...
class PostPartnerManagedCompaniesCompanyUUIDAcceptTermsOfServiceRequest(BaseModel):
    ...
    partner_managed_company_accept_terms_of_service_request: Annotated[
        PartnerManagedCompanyAcceptTermsOfServiceRequest,
    ...
    ] = PostPartnerManagedCompaniesCompanyUUIDAcceptTermsOfServiceHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
