...
class PayrollShowAmountType(str, Enum):
    r"""The amount type of the deduction for the pay period. Only present for calculated or processed payrolls."""
...
class PayrollShowDeductionsTypedDict(TypedDict):
    ...
    r"""The amount type of the deduction for the pay period. Only present for calculated or processed payrolls."""
    uuid: NotRequired[str]
    r"""The UUID of the deduction. Only present for calculated or processed payrolls."""
