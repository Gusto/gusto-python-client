...
class PostPayrollsGrossUpPayrollUUIDRequestTypedDict(TypedDict):
    ...
    payroll_gross_up_request: PayrollGrossUpRequestTypedDict
...
class PostPayrollsGrossUpPayrollUUIDRequest(BaseModel):
    ...
    payroll_gross_up_request: Annotated[
        PayrollGrossUpRequest,
    ...
    ] = PostPayrollsGrossUpPayrollUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
