...
class PostV1ContractorsContractorUUIDBankAccountsRequestTypedDict(TypedDict):
    ...
    contractor_bank_account_create_request_body: (
        ContractorBankAccountCreateRequestBodyTypedDict
    )
...
class PostV1ContractorsContractorUUIDBankAccountsRequest(BaseModel):
    ...
    contractor_bank_account_create_request_body: Annotated[
        ContractorBankAccountCreateRequestBody,
    ...
    ] = PostV1ContractorsContractorUUIDBankAccountsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
