...
class PutV1EmployeesEmployeeIDI9AuthorizationEmployerSignRequestTypedDict(TypedDict):
    ...
    i9_authorization_employer_sign_request_body: (
        I9AuthorizationEmployerSignRequestBodyTypedDict
    )
...
class PutV1EmployeesEmployeeIDI9AuthorizationEmployerSignRequest(BaseModel):
    ...
    i9_authorization_employer_sign_request_body: Annotated[
        I9AuthorizationEmployerSignRequestBody,
    ...
    ] = PutV1EmployeesEmployeeIDI9AuthorizationEmployerSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
