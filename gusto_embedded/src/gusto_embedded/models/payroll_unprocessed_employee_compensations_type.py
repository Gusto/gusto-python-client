...
class PayrollUnprocessedEmployeeCompensationsTypePaymentMethod(str, Enum):
...
class PayrollUnprocessedEmployeeCompensationsTypeAmountType(str, Enum):
...
class PayrollUnprocessedEmployeeCompensationsTypeTypedDict(TypedDict):
    ...
    r"""The employee's gross pay, equal to regular wages + cash tips + payroll tips + any other additional earnings, excluding imputed income."""
