...
class PutV1CompaniesCompanyIDPaySchedulesPayScheduleIDRequestTypedDict(TypedDict):
    ...
    pay_schedule_update_request: PayScheduleUpdateRequestTypedDict
...
class PutV1CompaniesCompanyIDPaySchedulesPayScheduleIDRequest(BaseModel):
    ...
    pay_schedule_update_request: Annotated[
        PayScheduleUpdateRequest,
    ...
    ] = PutV1CompaniesCompanyIDPaySchedulesPayScheduleIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
