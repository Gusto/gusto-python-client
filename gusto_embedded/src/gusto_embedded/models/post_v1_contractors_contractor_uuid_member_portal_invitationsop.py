...
class PostV1ContractorsContractorUUIDMemberPortalInvitationsHeaderXGustoAPIVersion(
    str, Enum
):
...
class PostV1ContractorsContractorUUIDMemberPortalInvitationsRequestTypedDict(TypedDict):
    contractor_uuid: str
...
class PostV1ContractorsContractorUUIDMemberPortalInvitationsRequest(BaseModel):
    ...
    ] = PostV1ContractorsContractorUUIDMemberPortalInvitationsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
