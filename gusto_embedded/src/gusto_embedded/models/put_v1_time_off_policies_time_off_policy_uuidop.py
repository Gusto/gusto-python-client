...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestTypedDict(TypedDict):
    ...
    request_body: PutV1TimeOffPoliciesTimeOffPolicyUUIDRequestBodyTypedDict
...
class PutV1TimeOffPoliciesTimeOffPolicyUUIDRequest(BaseModel):
    ...
    ] = PutV1TimeOffPoliciesTimeOffPolicyUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
