...
class PostV1PartnerManagedCompaniesRequestTypedDict(TypedDict):
    partner_managed_company_create_request: PartnerManagedCompanyCreateRequestTypedDict
...
class PostV1PartnerManagedCompaniesRequest(BaseModel):
    partner_managed_company_create_request: Annotated[
        PartnerManagedCompanyCreateRequest,
    ...
    ] = PostV1PartnerManagedCompaniesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS_06_MINUS_15
    r"""Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used."""
