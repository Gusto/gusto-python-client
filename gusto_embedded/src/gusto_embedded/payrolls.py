...
class Payrolls(BaseSDK):
    def list(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
    ...
    def create_off_cycle(
        ...
        *,
        ...
        ] = models.PostV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
    ...
    def get(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayrollsPayrollIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        include: Optional[
    ...
    def update(
        ...
        *,
        ...
        ] = models.PutV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
    ...
    def delete(
        ...
        *,
        ...
        ] = models.DeleteV1CompaniesCompanyIDPayrollsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def prepare(
        ...
        *,
        ...
        page: Optional[int] = None,
        per: Optional[int] = None,
        sort_by: Optional[models.PayrollPrepareSortBy] = None,
        x_gusto_api_version: Optional[
            models.VersionHeader
        ] = models.VersionHeader.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        employee_uuids: Optional[List[str]] = None,
        ...
        * Will return the version param used for updating the payroll
        ...
        :param page: The page that is requested. When unspecified, will load all objects unless endpoint forces pagination.
        :param per: Number of objects per page. For majority of endpoints will default to 25
        :param sort_by: Sort employee compenstations by name. Options: first_name, last_name
        :param x_gusto_api_version: Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
    ...
    def get_receipt(
        ...
        *,
        ...
        ] = models.GetV1PaymentReceiptsPayrollsPayrollUUIDHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def calculate_gross_up(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GrossUpPay, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.PostPayrollsGrossUpPayrollUUIDResponseBodyUnion, http_res
            )
            raise models.PostPayrollsGrossUpPayrollUUIDResponseBody(
                response_data, http_res
            )
        if utils.match_response(http_res, ["404", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    def cancel(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.Payroll, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                models.UnprocessableEntityErrorObjectData, http_res
            )
    ...
    def get_pay_stub(
        ...
        *,
        ...
        if utils.match_response(http_res, "404", "application/json"):
            http_res_text = utils.stream_to_text(http_res)
            response_data = unmarshal_json_response(
                models.UnprocessableEntityErrorObjectData, http_res, http_res_text
            )
            raise models.UnprocessableEntityErrorObject(
    ...
    def get_v1_companies_company_id_payrolls_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.GetV1CompaniesCompanyIDPayrollsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ...
    def patch_v1_companies_company_id_payrolls_id_partner_disbursements(
        ...
        *,
        ...
        ] = models.PatchV1CompaniesCompanyIDPayrollsIDPartnerDisbursementsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FOUR_MINUS_04_MINUS_01,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
