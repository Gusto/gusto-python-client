...
class PaymentConfigsSDK(BaseSDK):
    def get_v1_company_payment_configs(
        self,
        *,
        company_uuid: str,
    ...
    async def get_v1_company_payment_configs_async(
        self,
        *,
        company_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def put_v1_company_payment_configs(
        self,
        *,
        company_uuid: str,
        request_body: Union[
    ...
    async def put_v1_company_payment_configs_async(
        self,
        *,
        company_uuid: str,
        request_body: Union[
