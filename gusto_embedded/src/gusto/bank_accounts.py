...
class BankAccounts(BaseSDK):
    def post_v1_companies_company_id_bank_accounts(
        self,
        *,
        company_id: str,
    ...
    async def post_v1_companies_company_id_bank_accounts_async(
        self,
        *,
        company_id: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def get_v1_companies_company_id_bank_accounts(
        self,
        *,
        company_id: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def get_v1_companies_company_id_bank_accounts_async(
        self,
        *,
        company_id: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def put_v1_companies_company_id_bank_accounts_verify(
        self,
        *,
    ...
    async def put_v1_companies_company_id_bank_accounts_verify_async(
        self,
        *,
        bank_account_uuid: str,
        company_id: str,
    ...
    def post_v1_plaid_processor_token(
        self,
        *,
    ...
    async def post_v1_plaid_processor_token_async(
        self,
        *,
        owner_type: models.OwnerType,
        owner_id: str,
