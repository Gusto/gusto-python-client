...
class EmployeeForms(BaseSDK):
    def post_v1_sandbox_generate_w2(
        self,
        *,
        employee_id: str,
    ...
    async def post_v1_sandbox_generate_w2_async(
        self,
        *,
        employee_id: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def get_v1_employee_forms_async(
        self,
        *,
        employee_id: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def get_v1_employee_form_pdf_async(
        self,
        *,
        employee_id: str,
        form_id: str,
    ...
    async def put_v1_employee_form_sign_async(
        self,
        *,
        employee_id: str,
        form_id: str,
