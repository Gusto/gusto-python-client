...
class ContractorPayments(BaseSDK):
    def get_v1_contractor_payments_contractor_payment_uuid_receipt(
        self,
        *,
    ...
    async def get_v1_contractor_payments_contractor_payment_uuid_receipt_async(
        self,
        *,
        contractor_payment_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def get_v1_contractor_payments_contractor_payment_uuid_fund(
        self,
        *,
        contractor_payment_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    async def get_v1_contractor_payments_contractor_payment_uuid_fund_async(
        self,
        *,
        contractor_payment_uuid: str,
        x_gusto_api_version: Optional[models.VersionHeader] = None,
    ...
    def post_v1_companies_company_id_contractor_payments(
        self,
        *,
        company_id: str,
        contractor_uuid: str,
    ...
    async def post_v1_companies_company_id_contractor_payments_async(
        self,
        *,
        company_id: str,
        contractor_uuid: str,
    ...
    def get_companies_company_uuid_contractor_payments_preview(
        self,
        *,
        company_uuid: str,
    ...
    async def get_companies_company_uuid_contractor_payments_preview_async(
        self,
        *,
        company_uuid: str,
        contractor_payments: Union[
